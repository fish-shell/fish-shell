...
complete -c ansible -s t -l tree -f -a "(__ghoti_complete_directories)" -d "Log output to this directory"
...
complete -c ansible -s u -l user -f -a "(__ghoti_complete_users)" -d "Connect as this user (default=None)"
...
complete -c ansible -l become-user -r -f -a "(__ghoti_complete_users)" -d "Run operations as this user (default=root)"
