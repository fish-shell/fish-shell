...
complete -f -c eopkg -n '__fish_seen_subcommand_from remove-repo rr enable-repo er disable-repo dr search sr list-available la' -a "(__fish_eopkg_print_repos)" -d "Repository"
