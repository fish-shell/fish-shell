...
complete -c darcs -n '__fish_use_subcommand' -x -a test --description 'Run regression test'
...
complete -c darcs -n '__fish_use_subcommand' -x -a fetch --description 'Fetch patches from another repository, but don\'t apply them'
...
complete -c darcs -n 'contains \'help\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'add\' (commandline -poc)' -l no-boring --description 'Skip boring files [DEFAULT]'
...
complete -c darcs -n 'contains \'add\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'remove\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'move\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'replace\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'revert\' (commandline -poc)' -s u -l unified --description 'Output changes in a darcs-specific format similar to diff -u'
complete -c darcs -n 'contains \'revert\' (commandline -poc)' -l no-unified --description 'Output changes in darcs\' usual format'
...
complete -c darcs -n 'contains \'revert\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'unrevert\' (commandline -poc)' -s u -l unified --description 'Output changes in a darcs-specific format similar to diff -u'
complete -c darcs -n 'contains \'unrevert\' (commandline -poc)' -l no-unified --description 'Output changes in darcs\' usual format'
...
complete -c darcs -n 'contains \'unrevert\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'whatsnew\' (commandline -poc)' -s u -l unified --description 'Output changes in a darcs-specific format similar to diff -u'
complete -c darcs -n 'contains \'whatsnew\' (commandline -poc)' -l no-unified --description 'Output changes in darcs\' usual format'
...
complete -c darcs -n 'contains \'whatsnew\' (commandline -poc)' -l no-boring --description 'Skip boring files [DEFAULT]'
...
complete -c darcs -n 'contains \'record\' (commandline -poc)' -s m -l name -x --description 'Name of patch'
...
complete -c darcs -n 'contains \'record\' (commandline -poc)' -s u -l unified --description 'Output changes in a darcs-specific format similar to diff -u'
complete -c darcs -n 'contains \'record\' (commandline -poc)' -l no-unified --description 'Output changes in darcs\' usual format'
...
complete -c darcs -n 'contains \'record\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'unrecord\' (commandline -poc)' -l reverse --description 'Show changes in reverse order'
complete -c darcs -n 'contains \'unrecord\' (commandline -poc)' -l no-reverse --description 'Show changes in the usual order [DEFAULT]'
complete -c darcs -n 'contains \'unrecord\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'amend-record\' (commandline -poc)' -s m -l name -x --description 'Name of patch'
complete -c darcs -n 'contains \'amend-record\' (commandline -poc)' -l ask-deps --description 'Ask for extra dependencies'
complete -c darcs -n 'contains \'amend-record\' (commandline -poc)' -l no-ask-deps --description 'Don\'t ask for extra dependencies'
...
complete -c darcs -n 'contains \'amend-record\' (commandline -poc)' -l keep-date --description 'Keep the date of the original patch'
complete -c darcs -n 'contains \'amend-record\' (commandline -poc)' -l no-keep-date --description 'Use the current date for the amended patch'
...
complete -c darcs -n 'contains \'amend-record\' (commandline -poc)' -l add --description 'Add the changes to patch (default)'
complete -c darcs -n 'contains \'amend-record\' (commandline -poc)' -l unrecord --description 'Subtract the changes from patch'
complete -c darcs -n 'contains \'amend-record\' (commandline -poc)' -s u -l unified --description 'Output changes in a darcs-specific format similar to diff -u'
complete -c darcs -n 'contains \'amend-record\' (commandline -poc)' -l no-unified --description 'Output changes in darcs\' usual format'
...
complete -c darcs -n 'contains \'amend-record\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'mark-conflicts\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'tag\' (commandline -poc)' -s m -l name -x --description 'Name of patch'
...
complete -c darcs -n 'contains \'tag\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'setpref\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'setpref\' (commandline -poc)' --description 'The path to a version-controlled boring file'
complete -c darcs -n 'contains \'setpref\' (commandline -poc)' --description 'The path to a version-controlled binaries file'
...
complete -c darcs -n 'contains \'diff\' (commandline -poc)' -s u -l unified --description 'Pass -u option to diff [DEFAULT]'
...
complete -c darcs -n 'contains \'diff\' (commandline -poc)' -l pause-for-gui --description 'Pause for an external diff or merge command to finish [DEFAULT]'
complete -c darcs -n 'contains \'diff\' (commandline -poc)' -l no-pause-for-gui --description 'Return immediately after external diff or merge command finishes'
complete -c darcs -n 'contains \'diff\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'annotate\' (commandline -poc)' -s u -l unified --description 'Output changes in a darcs-specific format similar to diff -u'
complete -c darcs -n 'contains \'annotate\' (commandline -poc)' -l no-unified --description 'Output changes in darcs\' usual format'
complete -c darcs -n 'contains \'annotate\' (commandline -poc)' -l machine-readable --description 'Give machine-readable output'
...
complete -c darcs -n 'contains \'annotate\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'dist\' (commandline -poc)' -l set-scripts-executable --description 'Make scripts executable'
...
complete -c darcs -n 'contains \'dist\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
#
# Completions for the 'test' subcommand
#

complete -c darcs -n 'contains \'test\' (commandline -poc)' -l leave-test-directory --description 'Don\'t remove the test directory'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l remove-test-directory --description 'Remove the test directory'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l repodir -x -a '(__fish_complete_directories (commandline -ct))' --description 'Specify the repository directory in which to run'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l disable --description 'Disable this command'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -s h -l help --description 'Shows brief description of command and its arguments'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l debug --description 'Give only debug output'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l debug-verbose --description 'Give debug and verbose output'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l debug-http --description 'Give debug output for libcurl'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -s v -l verbose --description 'Give verbose output'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -s q -l quiet --description 'Suppress informational output'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l standard-verbosity --description 'Neither verbose nor quiet output'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l timings --description 'Provide debugging timings information'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l posthook -x -a '(__fish_complete_command)' --description 'Specify command to run after this darcs command'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l no-posthook --description 'Don\'t run posthook command'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l prompt-posthook --description 'Prompt before running posthook [DEFAULT]'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l run-posthook --description 'Run posthook command without prompting'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l prehook -x -a '(__fish_complete_command)' --description 'Specify command to run before this darcs command'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l no-prehook --description 'Don\'t run prehook command'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l prompt-prehook --description 'Prompt before running prehook [DEFAULT]'
complete -c darcs -n 'contains \'test\' (commandline -poc)' -l run-prehook --description 'Run prehook command without prompting'
...
complete -c darcs -n 'contains \'trackdown\' (commandline -poc)' -l bisect --description 'Binary instead of linear search'
...
complete -c darcs -n 'contains \'trackdown\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'pull\' (commandline -poc)' -l set-default --description 'Set default repository'
complete -c darcs -n 'contains \'pull\' (commandline -poc)' -l no-set-default --description 'Don\'t set default repository [DEFAULT]'
...
complete -c darcs -n 'contains \'pull\' (commandline -poc)' -l reverse --description 'Show changes in reverse order'
complete -c darcs -n 'contains \'pull\' (commandline -poc)' -l no-reverse --description 'Show changes in the usual order [DEFAULT]'
complete -c darcs -n 'contains \'pull\' (commandline -poc)' -l pause-for-gui --description 'Pause for an external diff or merge command to finish [DEFAULT]'
complete -c darcs -n 'contains \'pull\' (commandline -poc)' -l no-pause-for-gui --description 'Return immediately after external diff or merge command finishes'
...
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l matches -x --description 'Select patches matching PATTERN'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -s p -l patches -x --description 'Select patches matching REGEXP'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -s t -l tags -x --description 'Select tags matching REGEXP'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -s a -l all --description 'Answer yes to all patches'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -s i -l interactive --description 'Prompt user interactively'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l dry-run --description 'Don\'t actually take the action'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l xml-output --description 'Generate XML formatted output'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -s s -l summary --description 'Summarize changes'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l no-summary --description 'Don\'t summarize changes'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l no-deps --description 'Don\'t automatically fulfill dependencies'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l dont-prompt-for-dependencies --description 'Don\'t ask about patches that are depended on by matched patches (with --match or --patch)'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l prompt-for-dependencies --description 'Prompt about patches that are depended on by matched patches [DEFAULT]'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l set-default --description 'Set default repository'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l no-set-default --description 'Don\'t set default repository [DEFAULT]'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l repodir -x -a '(__fish_complete_directories (commandline -ct))' --description 'Specify the repository directory in which to run'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -s o -l output -r --description 'Specify output filename'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l ignore-unrelated-repos --description 'Do not check if repositories are unrelated'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l disable --description 'Disable this command'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -s h -l help --description 'Shows brief description of command and its arguments'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l debug --description 'Give only debug output'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l debug-verbose --description 'Give debug and verbose output'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l debug-http --description 'Give debug output for libcurl'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -s v -l verbose --description 'Give verbose output'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -s q -l quiet --description 'Suppress informational output'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l standard-verbosity --description 'Neither verbose nor quiet output'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l timings --description 'Provide debugging timings information'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l intersection --description 'Take intersection of all repositories'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l union --description 'Take union of all repositories [DEFAULT]'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l complement --description 'Take complement of repositories (in order listed)'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l remote-repo -x --description 'Specify the remote repository URL to work with'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l no-http-pipelining --description 'Disable HTTP pipelining'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l remote-darcs -x -a '(__fish_complete_command)' --description 'Name of the darcs executable on the remote server'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l posthook -x -a '(__fish_complete_command)' --description 'Specify command to run after this darcs command'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l no-posthook --description 'Don\'t run posthook command'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l prompt-posthook --description 'Prompt before running posthook [DEFAULT]'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l run-posthook --description 'Run posthook command without prompting'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l prehook -x -a '(__fish_complete_command)' --description 'Specify command to run before this darcs command'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l no-prehook --description 'Don\'t run prehook command'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l prompt-prehook --description 'Prompt before running prehook [DEFAULT]'
complete -c darcs -n 'contains \'fetch\' (commandline -poc)' -l run-prehook --description 'Run prehook command without prompting'
...
complete -c darcs -n 'contains \'obliterate\' (commandline -poc)' -s o -l output -r --description 'Specify output filename'
...
complete -c darcs -n 'contains \'obliterate\' (commandline -poc)' -l reverse --description 'Show changes in reverse order'
complete -c darcs -n 'contains \'obliterate\' (commandline -poc)' -l no-reverse --description 'Show changes in the usual order [DEFAULT]'
complete -c darcs -n 'contains \'obliterate\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'rollback\' (commandline -poc)' -s m -l name -x --description 'Name of patch'
...
complete -c darcs -n 'contains \'rollback\' (commandline -poc)' -l record --description 'Record the rollback patch (default)'
complete -c darcs -n 'contains \'rollback\' (commandline -poc)' -l no-record --description 'Don\'t record the rollback patch (only roll back in working dir)'
...
complete -c darcs -n 'contains \'rollback\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'push\' (commandline -poc)' -l set-default --description 'Set default repository'
complete -c darcs -n 'contains \'push\' (commandline -poc)' -l no-set-default --description 'Don\'t set default repository [DEFAULT]'
...
complete -c darcs -n 'contains \'push\' (commandline -poc)' -l reverse --description 'Show changes in reverse order'
complete -c darcs -n 'contains \'push\' (commandline -poc)' -l no-reverse --description 'Show changes in the usual order [DEFAULT]'
...
complete -c darcs -n 'contains \'send\' (commandline -poc)' -l charset -x --description 'Specify mail charset'
...
complete -c darcs -n 'contains \'send\' (commandline -poc)' -l edit-description --description 'Edit the patch bundle description [DEFAULT]'
complete -c darcs -n 'contains \'send\' (commandline -poc)' -l set-default --description 'Set default repository'
complete -c darcs -n 'contains \'send\' (commandline -poc)' -l no-set-default --description 'Don\'t set default repository [DEFAULT]'
...
complete -c darcs -n 'contains \'send\' (commandline -poc)' -l reverse --description 'Show changes in reverse order'
complete -c darcs -n 'contains \'send\' (commandline -poc)' -l no-reverse --description 'Show changes in the usual order [DEFAULT]'
...
complete -c darcs -n 'contains \'apply\' (commandline -poc)' -l matches -x --description 'Select patches matching PATTERN'
complete -c darcs -n 'contains \'apply\' (commandline -poc)' -s p -l patches -x --description 'Select patches matching REGEXP'
complete -c darcs -n 'contains \'apply\' (commandline -poc)' -s t -l tags -x --description 'Select tags matching REGEXP'
...
complete -c darcs -n 'contains \'apply\' (commandline -poc)' -l reverse --description 'Show changes in reverse order'
complete -c darcs -n 'contains \'apply\' (commandline -poc)' -l no-reverse --description 'Show changes in the usual order [DEFAULT]'
complete -c darcs -n 'contains \'apply\' (commandline -poc)' -l pause-for-gui --description 'Pause for an external diff or merge command to finish [DEFAULT]'
complete -c darcs -n 'contains \'apply\' (commandline -poc)' -l no-pause-for-gui --description 'Return immediately after external diff or merge command finishes'
complete -c darcs -n 'contains \'apply\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'get\' (commandline -poc)' -l with-working-dir --description 'Create a working directory (normal repository)'
complete -c darcs -n 'contains \'get\' (commandline -poc)' -l no-working-dir --description 'Do not create a working directory (bare repository)'
...
complete -c darcs -n 'contains \'get\' (commandline -poc)' -l packs --description 'Use repository packs [DEFAULT]'
complete -c darcs -n 'contains \'get\' (commandline -poc)' -l no-packs --description 'Don\'t use repository packs'
...
complete -c darcs -n 'contains \'put\' (commandline -poc)' -l set-default --description 'Set default repository'
complete -c darcs -n 'contains \'put\' (commandline -poc)' -l no-set-default --description 'Don\'t set default repository [DEFAULT]'
...
complete -c darcs -n 'contains \'initialize\' (commandline -poc)' -l with-working-dir --description 'Create a working directory (normal repository)'
complete -c darcs -n 'contains \'initialize\' (commandline -poc)' -l no-working-dir --description 'Do not create a working directory (bare repository)'
...
complete -c darcs -n 'contains \'initialize\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'optimize\' (commandline -poc)' -l http --description 'Optimize repository for getting over network'
...
complete -c darcs -n 'contains \'optimize\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'check\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
...
complete -c darcs -n 'contains \'repair\' (commandline -poc)' -l no-cache --description 'Don\'t use patch caches'
