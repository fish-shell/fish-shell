complete -c latexmk -k -x -a "(__ghoti_complete_suffix --description='(La)TeX file' .tex)"
...
complete -c latexmk -o latex= -d 'set program used for latex' -xa '(__ghoti_complete_command)'
...
complete -c latexmk -o output-directory= -o outdir= -d 'set name of directory for output files' -xa '(__ghoti_complete_directories)'
complete -c latexmk -o pdf -d 'generate pdf by pdflatex'
complete -c latexmk -o pdfdvi -d 'generate pdf by dvipdf'
complete -c latexmk -o pdflatex= -d 'set program used for pdflatex' -xa '(__ghoti_complete_command)'
