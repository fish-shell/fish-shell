...
# Primary command
complete -f -c btrfs -n __ghoti_is_first_arg -a check -d 'Check structural integrity of a filesystem (unmounted).'
complete -f -c btrfs -n __ghoti_is_first_arg -a restore -d 'Try to restore files from a damaged filesystem (unmounted)'
complete -f -c btrfs -n __ghoti_is_first_arg -a send -d 'Send the subvolume(s) to stdout.'
complete -f -c btrfs -n __ghoti_is_first_arg -a receive -d 'Receive subvolumes from a stream'
complete -f -c btrfs -n __ghoti_is_first_arg -a help -d 'Display help information'
complete -f -c btrfs -n __ghoti_is_first_arg -a version -d 'Display btrfs-progs version'

# Primary command groups
complete -f -c btrfs -n __ghoti_is_first_arg -a subvolume -d 'manage subvolumes: create, delete, list, etc'
complete -f -c btrfs -n __ghoti_is_first_arg -a filesystem -d 'overall filesystem tasks and information'
complete -f -c btrfs -n __ghoti_is_first_arg -a balance -d 'balance data across devices, or change block groups using filters'
complete -f -c btrfs -n __ghoti_is_first_arg -a device -d 'manage and query devices in the filesystem'
complete -f -c btrfs -n __ghoti_is_first_arg -a scrub -d 'verify checksums of data and metadata'
complete -f -c btrfs -n __ghoti_is_first_arg -a rescue -d 'toolbox for specific rescue operations'
complete -f -c btrfs -n __ghoti_is_first_arg -a inspect-internal -d 'query various internal information'
complete -f -c btrfs -n __ghoti_is_first_arg -a property -d 'modify properties of filesystem objects'
complete -f -c btrfs -n __ghoti_is_first_arg -a quota -d 'manage filesystem quota settings'
complete -f -c btrfs -n __ghoti_is_first_arg -a qgroup -d 'manage quota groups'
complete -f -c btrfs -n __ghoti_is_first_arg -a replace -d 'replace a device in the filesystem'
