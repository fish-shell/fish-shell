...
- If the terminal can distinguish :kbd:`ctrl-backspace` from `ctrl-h`,
  then :kbd:`ctrl-backspace` removes one word backwards and :kbd:`alt-backspace` removes one argument backwards.
  Otherwise, :kbd:`alt-backspace` removes one word backwards.
