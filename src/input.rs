...
const INPUT_FUNCTION_METADATA: &[InputFunctionMetadata] = &[
    ...
    make_md(L!("backward-delete-bigword"), ReadlineCmd::BackwardDeleteBigword),
    make_md(L!("backward-delete-char"), ReadlineCmd::BackwardDeleteChar),
    make_md(L!("backward-delete-path-component"), ReadlineCmd::BackwordDeletePathComponent),
    make_md(L!("backward-delete-word"), ReadlineCmd::BackwardDeleteWord),
    ...
    make_md(L!("delete-bigword"), ReadlineCmd::DeleteBigword),
    make_md(L!("delete-char"), ReadlineCmd::DeleteChar),
    make_md(L!("delete-or-exit"), ReadlineCmd::DeleteOrExit),
    make_md(L!("delete-word"), ReadlineCmd::DeleteWord),
