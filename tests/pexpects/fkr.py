...
send("\x07")
expect_str("bind [c-g] 'do something'\r\n")

# Is a non-ASCII UTF-8 sequence prefaced by an escape char handled correctly?
sleep(0.020)
# TODO Why can't we bind the sequence?
send("\x1B")
expect_str("bind [esc] 'do something'\r\n")
send("\u1234")
...
sleep(0.020)
send("\x00")
expect_str("bind [c-space] 'do something'\r\n")

send("\x1b\x7f")
expect_str("bind [a-backspace] 'do something'\r\n")

send("\x1c")
expect_str(r"bind [c-\\] 'do something'")
