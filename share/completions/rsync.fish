...
complete -c rsync -l crtimes -d "Preserve create times (newness)"
...
complete -c rsync -l checksum-choice -xa '{xxh128,xxh3,xxh64,md5,md4,none}' -d "Choose the checksum algorithm (aka --cc)"
...
complete -c rsync -l compress-choice -xa '{zstd,lz4,zlibx,zlib,none}' -d "Choose the compression algorithm (aka --zc)"
