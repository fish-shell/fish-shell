function __fish_security_keychains
    security list-keychains | string trim | string trim -c '"' | string match -v ''
end
...
complete -c security -f -n '__fish_seen_subcommand_from help' -a '(security help | string match -r "^\s+\S+" | string trim)'
...
complete -c security -n '__fish_seen_subcommand_from create-keychain' -s P -d 'Prompt for a password using the SecurityAgent'
...
complete -c security -n '__fish_seen_subcommand_from unlock-keychain' -s u -d 'Do not use the supplied password to unlock'
complete -c security -f -n '__fish_seen_subcommand_from unlock-keychain' -s p -x -d 'Use the given password to unlock'

complete -c security -n '__fish_seen_subcommand_from set-keychain-settings' -s l -d 'Lock keychain when the system sleeps'
complete -c security -n '__fish_seen_subcommand_from set-keychain-settings' -s u -d 'Lock keychain after timeout interval'
...
complete -c security -n '__fish_seen_subcommand_from dump-keychain' -s a -d 'Dump access control list of items'
complete -c security -n '__fish_seen_subcommand_from dump-keychain' -s d -d 'Dump (decrypted) data of items'
complete -c security -n '__fish_seen_subcommand_from dump-keychain' -s i -d 'Interactive access control list editing mode'
complete -c security -n '__fish_seen_subcommand_from dump-keychain' -s r -d 'Dump raw (encrypted) data of items'
...
complete -c security -n '__fish_seen_subcommand_from create-keypair' -s A -d 'Allow any application to access this key (insecure)'
...
complete -c security -n '__fish_seen_subcommand_from add-generic-password add-internet-password' -s A -d 'Allow any application to access this item (insecure)'
...
complete -c security -n '__fish_seen_subcommand_from add-generic-password add-internet-password' -s U -d 'Update item if it already exists'
...
complete -c security -n '__fish_seen_subcommand_from find-generic-password' -s g -d 'Display the password for the item found'
complete -c security -n '__fish_seen_subcommand_from find-generic-password' -s w -d 'Display only the password for the item found'
...
complete -c security -n '__fish_seen_subcommand_from find-internet-password' -s g -d 'Display the password for the item found'
complete -c security -n '__fish_seen_subcommand_from find-internet-password' -s w -d 'Display only the password for the item found'
...
complete -c security -n '__fish_seen_subcommand_from find-key' -s d -d 'Match keys that can decrypt'
complete -c security -f -n '__fish_seen_subcommand_from find-key' -s D -x -d 'Match description string'
complete -c security -n '__fish_seen_subcommand_from find-key' -s e -d 'Match keys that can encrypt'
...
complete -c security -n '__fish_seen_subcommand_from find-key' -s r -d 'Match keys that can derive'
complete -c security -n '__fish_seen_subcommand_from find-key' -s s -d 'Match keys that can sign'
complete -c security -f -n '__fish_seen_subcommand_from find-key' -s t -x -a 'symmetric public private' -d 'Type of key to find'
complete -c security -n '__fish_seen_subcommand_from find-key' -s u -d 'Match keys that can unwrap'
complete -c security -n '__fish_seen_subcommand_from find-key' -s v -d 'Match keys that can verify'
complete -c security -n '__fish_seen_subcommand_from find-key' -s w -d 'Match keys that can wrap'
...
complete -c security -n '__fish_seen_subcommand_from find-certificate' -s a -d 'Find all matching certificates, not just the first'
...
complete -c security -n '__fish_seen_subcommand_from find-certificate' -s m -d 'Show the email addresses in the certificate'
complete -c security -n '__fish_seen_subcommand_from find-certificate' -s p -d 'Output certificate in PEM format'
complete -c security -n '__fish_seen_subcommand_from find-certificate' -s Z -d 'Print SHA-256 (and SHA-1) hash of the certificate'
...
complete -c security -n '__fish_seen_subcommand_from delete-certificate delete-identity' -s t -d 'Also delete user trust settings for this certificate'
...
complete -c security -n '__fish_seen_subcommand_from set-identity-preference' -s n -d 'No identity; delete the preference'
...
complete -c security -n '__fish_seen_subcommand_from get-identity-preference' -s p -d 'Output identity certificate in PEM format'
complete -c security -n '__fish_seen_subcommand_from get-identity-preference' -s c -d 'Print common name of the preferred identity'
complete -c security -n '__fish_seen_subcommand_from get-identity-preference' -s Z -d 'Print SHA-1 hash of the preferred identity'
...
complete -c security -n '__fish_seen_subcommand_from export' -s w -d 'Wrap private keys on export'
complete -c security -n '__fish_seen_subcommand_from export' -s p -d 'Apply PEM armour to the output data'
...
complete -c security -n '__fish_seen_subcommand_from import' -s w -d 'Private keys are wrapped and must be unwrapped on import'
complete -c security -n '__fish_seen_subcommand_from import' -s x -d 'Private keys are non-extractable after import'
...
complete -c security -n '__fish_seen_subcommand_from import' -s A -d 'Allow any application to access the imported key (insecure)'
complete -c security -n '__fish_seen_subcommand_from import' -s T -d 'Specify an application which may access the imported key'

complete -c security -n '__fish_seen_subcommand_from cms' -s C -d 'Create a CMS encrypted message'
complete -c security -n '__fish_seen_subcommand_from cms' -s D -d 'Decode a CMS message'
complete -c security -n '__fish_seen_subcommand_from cms' -s E -d 'Create a CMS enveloped message'
complete -c security -n '__fish_seen_subcommand_from cms' -s S -d 'Create a CMS signed message'

complete -c security -n '__fish_seen_subcommand_from add-trusted-cert' -s d -d 'Add to admin cert store (default is user)'
...
complete -c security -n '__fish_seen_subcommand_from remove-trusted-cert' -s d -d 'Remove from admin cert store (default is user)'

complete -c security -n '__fish_seen_subcommand_from trust-settings-export' -s s -d 'Export system trust settings'
complete -c security -n '__fish_seen_subcommand_from trust-settings-export trust-settings-import' -s d -d 'Operate on admin (system) trust settings'
...
complete -c security -n '__fish_seen_subcommand_from verify-cert' -s C -d 'Evaluation is for client usage'
...
complete -c security -n '__fish_seen_subcommand_from authorize' -s u -d 'Allow user interaction'
complete -c security -n '__fish_seen_subcommand_from authorize' -s p -d 'Allow returning partial rights'
complete -c security -n '__fish_seen_subcommand_from authorize' -s d -d 'Destroy acquired rights'
complete -c security -n '__fish_seen_subcommand_from authorize' -s P -d 'Pre-authorize rights only'
complete -c security -n '__fish_seen_subcommand_from authorize' -s l -d 'Operate authorization in least privileged mode'
complete -c security -n '__fish_seen_subcommand_from authorize' -s i -d 'Internalize authref passed on stdin'
complete -c security -n '__fish_seen_subcommand_from authorize' -s e -d 'Externalize authref to stdout'
complete -c security -n '__fish_seen_subcommand_from authorize' -s w -d 'Wait while holding AuthorizationRef until stdout closes'
...
complete -c security -n '__fish_seen_subcommand_from smartcards' -s l -d 'List disabled smartcard tokens'
