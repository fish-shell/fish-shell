...
fn test_math(argv: &mut [&wstr], expected_ans: &str, parser: &&Parser, stream: &mut IoStreams, ans_lst: &mut String) {
...
fn test_round() {
    ...
    let mut argv = [utf32str!("math"), utf32str!("-s"), utf32str!("0"), utf32str!("--scale-mode=trunc"), utf32str!("22 / 5 - 5")];
    test_math(&mut argv, "-0", parser, &mut stream, &mut ans_lst);

    let mut argv = [utf32str!("math"), utf32str!("--scale=0"), utf32str!("-m"), utf32str!("trunc"), utf32str!("22 / 5 - 5")];
    test_math(&mut argv, "-0", parser, &mut stream, &mut ans_lst);

    let mut argv = [utf32str!("math"), utf32str!("-s"), utf32str!("0"), utf32str!("--scale-mode=floor"), utf32str!("22 / 5 - 5")];
    test_math(&mut argv, "-1", parser, &mut stream, &mut ans_lst);

    let mut argv = [utf32str!("math"), utf32str!("-s"), utf32str!("0"), utf32str!("--scale-mode=round"), utf32str!("22 / 5 - 5")];
    test_math(&mut argv, "-1", parser, &mut stream, &mut ans_lst);

    let mut argv = [utf32str!("math"), utf32str!("-s"), utf32str!("0"), utf32str!("--scale-mode=ceil"), utf32str!("22 / 5 - 5")];
    test_math(&mut argv, "-0", parser, &mut stream, &mut ans_lst);
