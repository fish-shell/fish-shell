...
function __ghoti_vim-addons_subcommand -d 'Test if vim-addons has yet to be given the subcommand'
...
# --------
# list
complete -c vim-addons -n __ghoti_vim-addons_subcommand -a list -f -d "list the names of the addons available in the system"
# status
complete -c vim-addons -n __ghoti_vim-addons_subcommand -a status -f -d "show the status of the addons available in the system"
complete -c vim-addons -n "contains status (commandline -poc)" -a "(vim-addons list)" -x
# install
complete -c vim-addons -n __ghoti_vim-addons_subcommand -a install -x -d "install one or more addons under ~/.vim"
complete -c vim-addons -n "contains install (commandline -poc)" -a "(vim-addons status | awk '\$2 != \"installed\" && \$1 != \"#\" { print \$1}')" -x
# remove
complete -c vim-addons -n __ghoti_vim-addons_subcommand -a remove -x -d "remove one or more addons from ~/.vim"
complete -c vim-addons -n "contains remove (commandline -poc)" -a "(vim-addons status | awk '\$2 != \"removed\" && \$1 != \"#\" { print \$1}')" -x
# disable
complete -c vim-addons -n __ghoti_vim-addons_subcommand -a disable -x -d "disable  one  or more addons to be used by the current user"
complete -c vim-addons -n "contains disable (commandline -poc)" -a "(vim-addons status | awk '\$2 != \"disable\" && \$1 != \"#\" { print \$1}')" -x
# amend
complete -c vim-addons -n __ghoti_vim-addons_subcommand -a amend -x -d "undo the effects of a previous disable command"
complete -c vim-addons -n "contains amend (commandline -poc)" -a "(vim-addons list)" -x
# files
complete -c vim-addons -n __ghoti_vim-addons_subcommand -a files -x -d "list, one per line, the files composing the specified addons"
complete -c vim-addons -n "contains files (commandline -poc)" -a "(vim-addons list)" -x
# show
complete -c vim-addons -n __ghoti_vim-addons_subcommand -a show -x -d "displays detailed information about the specified addons"
