...
complete -c lpstat -s a -d 'Shows accepting state of selected printer queues' -xa '(__ghoti_print_lpr_printers)'
...
complete -c lpstat -s o -d 'Shows jobs queue on the specified destinations' -xa '(__ghoti_print_lpr_printers)'
complete -c lpstat -s p -d 'Shows printers and if they are enabled for printing' -xa '(__ghoti_print_lpr_printers)'
...
complete -c lpstat -s u -d 'Shows a list of print jobs queued by the specified users' -xa '(__ghoti_complete_users)'
complete -c lpstat -s v -d 'Shows printers and what device they are attached to' -xa '(__ghoti_print_lpr_printers)'
