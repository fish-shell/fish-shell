complete -c usermod -xa "(__ghoti_complete_users)"
...
complete -c usermod -s g -l gid -d "Group name or number of the user's new initial login group" -xa "(__ghoti_complete_groups)"
complete -c usermod -s G -l groups -d "List of groups which the user is also a member of" -xa "(__ghoti_complete_list , __ghoti_complete_groups)"
