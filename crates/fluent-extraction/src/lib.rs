...
fn append_fluent_id_to_file(fluent_id: String, mut file: File) {
...
/// If `FISH_FLUENT_ID_FILE` is defined in the environment,
...
/// # Panics
///
/// This macro panics if the `FISH_FLUENT_ID_FILE` variable is set and `fluent_id` has an
/// unexpected format.
...
pub fn fluent_extract(fluent_id: TokenStream) -> TokenStream {
    localization_extract(fluent_id, "FISH_FLUENT_ID_FILE", append_fluent_id_to_file)
}
