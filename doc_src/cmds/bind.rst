...
``scrollback-push``
    ...
    this command does nothing unless the terminal advertises support for that command,
    see `Terminal Compatibility <../terminal-compatibility.html#term-compat-xtgettcap>`_.
