...
mod test_expressions {
    ...
    impl<'a> TestParser<'a> {
        ...
        pub fn parse_args(args: &[WString]) -> Result<Box<dyn Expression>, error::Error<'_>> {
            ...
            // This is not detected by parse_expression() in which case we may
            // need to create our own error.
