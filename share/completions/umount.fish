...
#
complete -c umount -d "Mount point" -x -a '(__ghoti_print_mounted)'
...
complete -c umount -s t -l types -d "Actions should only be taken on file systems of the specified type" -xa "(__ghoti_print_filesystems)"
