...
complete -c subfinder -o h -o help -l help -f -d "Display help and exit"
...
complete -c subfinder -o recursive -f -d "Use only sources that can handle subdomains recursively"
complete -c subfinder -o all -f -d "Use all sources for enumeration (slow)"
...
# UPDATE
complete -c subfinder -o up -o update -f -d "Update subfinder to latest version"
complete -c subfinder -o duc -o disable-update-check -f -d "Disable automatic update check"

# OUTPUT
complete -c subfinder -o o -o output -r -d "File to write output to"
complete -c subfinder -o oJ -o json -f -d "Write output in JSONL format"
complete -c subfinder -o oD -o output-dir -x -a "(__fish_complete_directories)" -d "Directory to write output (-dL only)"
complete -c subfinder -o cs -o collect-sources -f -d "Include all sources in the output (-json only)"
complete -c subfinder -o oI -o ip -f -d "Include host IP in output (-active only)"
...
complete -c subfinder -o nW -o active -f -d "Display active subdomains only"
complete -c subfinder -o proxy -x -d "HTTP proxy to use"
complete -c subfinder -o ei -o exclude-ip -f -d "Exclude IPs from the list of domains"
complete -c subfinder -o mr -o max-results -x -d "Limit the number of results per source"

# DEBUG
complete -c subfinder -o silent -f -d "Show only subdomains"
complete -c subfinder -o version -f -d "Display version and exit"
complete -c subfinder -o v -f -d "Show verbose output"
complete -c subfinder -o nc -o no-color -f -d "Disable color in output"
complete -c subfinder -o ls -o list-sources -f -d "List all available sources"
complete -c subfinder -o stats -f -d "Report source statistics"
