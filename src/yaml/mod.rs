...
use crate::{
    ...
    history::{HistoryItem, PersistenceMode},
};
...
pub fn maybe_unescape_yaml_fish_2_0(s: &[u8]) -> Cow<[u8]> {
...
pub fn extract_prefix_and_unescape_yaml(line: &[u8]) -> Option<(Cow<[u8]>, Cow<[u8]>)> {
