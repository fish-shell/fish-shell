...
complete --command gacutil --short-option '?' --description 'Show help and exit'
...
complete --command gacutil --short-option l --condition "! __fish_seen_tokens $COMMANDS" --description 'Lists the contents of the global assembly cache'
...
complete --command gacutil --old-option gacdir --condition "__fish_seen_tokens $COMMANDS" --description 'Specify the GACs base directory'
...
complete --command gacutil --old-option check_refs --condition '__fish_seen_tokens -i -il' --description 'Ensure that the assembly being installed into the GAC does not reference any non strong named assemblies'
