...
complete -c reflector -n '__fish_seen_subcommand_from --sort' -xa age -d 'last server synchronization'
complete -c reflector -n '__fish_seen_subcommand_from --sort' -xa rate -d 'download rate'
complete -c reflector -n '__fish_seen_subcommand_from --sort' -xa country -d 'country name'
complete -c reflector -n '__fish_seen_subcommand_from --sort' -xa score -d 'MirrorStatus score'
complete -c reflector -n '__fish_seen_subcommand_from --sort' -xa delay -d 'MirrorStatus delay'
