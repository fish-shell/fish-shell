...
complete -c strace -s DD -l daemonize -d "Run  tracer  process as tracee's grandchild in a separate process group."
complete -c strace -s DDD -l daemonize -d "Run tracer process as tracee's grandchild in a separate session"
complete -c strace -s f -l follow-forks
complete -c strace -l output-separately
complete -c strace -s ff -d 'Combine the effects of --follow-forks and --output-separately options'
...
complete -c strace -s qq -l quiet
complete -c strace -s qqq -l quiet
...
complete -c strace -s tt -l absolute-timestamps -d 'If given twice, the time printed will include the microseconds'
complete -c strace -s ttt -l absolute-timestamps
...
complete -c strace -s yy -l decode-fds -d 'Print all available information associated with file descriptors'
