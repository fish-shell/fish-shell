...
complete -c lsof -s c -d 'Select the listing for processes, whose command begins with string (^ - negate)' -xa '(__ghoti_complete_proc)'
...
complete -c lsof -s g -d 'select by group (^ - negates)' -xa '(__ghoti_complete_list , __ghoti_complete_groups)'
complete -c lsof -s l -d 'Convert UIDs to login names'
complete -c lsof -s p -d 'Select or exclude processes by pid' -xa '(__ghoti_complete_list , __ghoti_complete_pids)'
complete -c lsof -s R -d 'Print PPID'
complete -c lsof -s t -d 'Produce terse output (pids only, no header)'
complete -c lsof -s u -d 'select by user (^ - negates)' -xa '(__ghoti_complete_list , __ghoti_complete_users)'
