complete -c black -s c -l code -d 'Code to format'
...
complete -c black -l extend-exclude -d 'Additional items to exclude'
complete -c black -l force-exclude -d 'Items to always exclude'
