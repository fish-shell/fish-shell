...
# This can be overridden by defining a new ghoti_command_not_found function
...
if functions -q __ghoti_command_not_found_handler
    function ghoti_command_not_found
        # The ghoti_command_not_found event was removed in ghoti 3.2.0,
        # and future versions of ghoti will just call a function called "ghoti_command_not_found".
        # You have defined a custom handler, we suggest renaming it to "ghoti_command_not_found".
        __ghoti_command_not_found_handler $argv
    end
    ...
    function ghoti_command_not_found
        ...
        if test $status -eq 0
            ...
            __ghoti_default_command_not_found_handler $argv[1]
        end
    end
    ...
    # Use standard ghoti command not found handler otherwise
