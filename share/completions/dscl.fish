...
set -l path_cmds read readall readpl readpli list search create createpl createpli append merge \
    delete deletepl deletepli change changei diff passwd
complete -c dscl -d 'Record type' -x -n "contains -- (__fish_dscl_command) $path_cmds" -a '(__fish_dscl_toplevel)'
complete -c dscl -x -n "contains -- (__fish_dscl_command) $path_cmds" -a '(__fish_dscl_records)'
