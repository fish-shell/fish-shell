...
complete -c tmux -n '__fish_use_subcommand' -s c -r -d 'Execute shell-command using the default shell'
complete -c tmux -n '__fish_use_subcommand' -s f -r -d 'Specify an alternative configuration file'
complete -c tmux -n '__fish_use_subcommand' -s L -x -d 'Specify the socket'
...
complete -c tmux -n '__fish_use_subcommand' -s S -r -d 'Specify a full alternative path to the server socket'
...
complete -c tmux -n '__fish_use_subcommand' -xs c   -d 'shell-command'
complete -c tmux -n '__fish_use_subcommand' -rs f   -d 'file'
complete -c tmux -n '__fish_use_subcommand' -rs L   -d 'socket-name'
complete -c tmux -n '__fish_use_subcommand' -rs S   -d 'socket-path'
###############  End:   Front  Flags ###############
