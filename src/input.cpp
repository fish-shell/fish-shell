...
static constexpr const input_function_metadata_t input_function_metadata[] = {
    ...
    {L"backward-path-component", readline_cmd_t::backward_path_component},
    ...
    {L"forward-path-component", readline_cmd_t::forward_path_component},
    ...
    {L"kill-path-component", readline_cmd_t::kill_path_component},
