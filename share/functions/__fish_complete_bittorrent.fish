...
function __ghoti_complete_bittorrent
    ...
    complete -c $argv -l ip --description "IP to report to the tracker" -x -a "(__ghoti_print_addresses)"
    ...
    complete -c $argv -l bind -x --description "IP to bind to locally" -a "(__ghoti_print_addresses --all)"
