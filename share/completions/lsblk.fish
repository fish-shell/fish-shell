function __ghoti_print_lsblk_columns --description 'Print available lsblk columns'
...
complete -c lsblk -s o -l output -d "output columns" -xa '( __ghoti_complete_list , __ghoti_print_lsblk_columns )'
