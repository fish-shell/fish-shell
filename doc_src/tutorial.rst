...
.. [#] There is a function called :ref:`alias <cmds/alias>`, but it's just a shortcut to make functions. Besides aliases, fish also provides :ref:`abbreviations <interactive-abbreviations>`, through the :ref:`abbr <cmds/abbr>` command.
