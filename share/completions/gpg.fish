...
complete -c gpg -l card-status -d "Print card status"
complete -c gpg -l change-passphrase -d "Change passphrase"
complete -c gpg -l change-pin -d "Change pin"
complete -c gpg -l check-signatures -d "List and check key signatures"
complete -c gpg -l clear-sign -d "Make clear text signature"
complete -c gpg -l delete-keys -d "Remove keys from public keyring"
complete -c gpg -l delete-secret-keys -d "Remove keys from secret keyring"
complete -c gpg -l edit-card -d "Change data on card"
complete -c gpg -l full-generate-key -d "Full featured key par generation"
complete -c gpg -l generate-key -d "Generate a new key pair"
complete -c gpg -l generate-revocation -d "Generate revocation certificate"
complete -c gpg -l list-signatures -d "List keys and signatures"
complete -c gpg -l openpgp -d "Use strict OpenPGP behavior"
complete -c gpg -l quick-add-uid -d "Quickly generate new key pair"
complete -c gpg -l quick-generate-key -d "Quickly generate new key pair"
complete -c gpg -l quick-lsign-key -d "Quickly sign key locally"
complete -c gpg -l quick-sign-key -d "Quickly sign key"
complete -c gpg -l quick-revoke-uid -d "Quickly revoke user-id"
complete -c gpg -l quick-set-expire -d "Quickly set new expiration date"
complete -c gpg -l receive-keys -d "Import keys from keyserver"
complete -c gpg -l server -d "Run in server mode"
complete -c gpg -l tofu-policy -x -d "Set given TOFU policy for key"
