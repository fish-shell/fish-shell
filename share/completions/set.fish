...
complete -c set -n "fish_is_nth_token 1" -s g -l global -d "Make variable global-scoped"
complete -c set -n "fish_is_nth_token 1" -s l -l local -d "Make variable local-scoped"
