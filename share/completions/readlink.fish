set -l is_gnu
__fish_supports_version readlink; and set is_gnu --is-gnu

__fish_gnu_complete -c readlink -s f -l canonicalize -d 'Canonicalize, follow symlinks, last can be missing' $is_gnu
__fish_gnu_complete -c readlink -s n -l no-newline -d 'Do not output the trailing newline' $is_gnu
