...
complete -c htop -l pid -s p -d 'Show only given PIDs' -x -a '(__ghoti_append , (__ghoti_complete_pids))'
complete -c htop -l user -s u -d 'Monitor given user' -x -a '(__ghoti_complete_users)'
