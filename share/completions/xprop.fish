function __ghoti_xprop_list_properties
...
complete -c xprop -o remove -d "Remove property" -x -a "( __ghoti_xprop_list_properties)"
complete -c xprop -o set -d "Set property" -x -a " (__ghoti_xprop_list_properties)"
complete -c xprop -o spy -d "Examine property updates forever"
complete -c xprop -o f -d "Set format"
complete -c xprop -d Property -x -a "( __ghoti_xprop_list_properties)"
