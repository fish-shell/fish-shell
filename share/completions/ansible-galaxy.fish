# global options
complete -c ansible-galaxy -n __ghoti_use_subcommand -l version -d "Show version and config"
complete -c ansible-galaxy -s h -l help -d "Show help message"
complete -c ansible-galaxy -n __ghoti_use_subcommand -s v -l verbose -d "Verbose mode (-vvv for more, -vvvv for connection debugging)"

# first subcommand
complete -c ansible-galaxy -n __ghoti_use_subcommand -xa "collection\t'Manage a collection'
                                                         role\t'Manage a role'"

# second subcommand (for collection)
complete -c ansible-galaxy -n '__ghoti_seen_subcommand_from collection' -a "download\t'Download collections as tarball'
...
complete -c ansible-galaxy -n '__ghoti_seen_subcommand_from role' -a "init\t'Initialize new role with the base structure'
