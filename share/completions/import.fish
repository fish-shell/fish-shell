...
complete -c import -o encoding -d 'Encoding type [type text]' -xa '(__ghoti_print_encodings)'
...
complete -c import -o transparent-color -d 'Transparent color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c import -o window -d 'Select window with this id or name [id]' -xa 'root (__ghoti_print_xwindows)'
...
complete -c import -o transparent -d 'Make this color transparent within the image [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c import -o log -d 'Format of debugging information [format]' -xa '(__ghoti_complete_convert_options format)'
