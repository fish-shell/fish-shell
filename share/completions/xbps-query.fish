...
set -l listall "(__ghoti_print_xbps_packages)"
set -l listinstalled "(__ghoti_print_xbps_packages -i)"

function __ghoti_print_xbps_pkg_props
...
complete -c $progname -n "__ghoti_contains_opt -s R" -a "$listall"

complete -c $progname -s C -d 'Use this XBPS configuration directory' -xa "(__ghoti_complete_directories)"
complete -c $progname -s c -d 'Use this cache directory to store binary packages' -xa "(__ghoti_complete_directories)"
...
complete -c $progname -s p -d 'Match one or more package properties' -xa "(__ghoti_complete_list , __ghoti_print_xbps_pkg_props)"
...
complete -c $progname -s r -d 'Use this path for the target root directory' -xa "(__ghoti_complete_directories)"
...
complete -c $progname -s X -d 'Show the reverse dependencies for PKG' -x -n "__ghoti_contains_opt -s R" -a "$listall"
