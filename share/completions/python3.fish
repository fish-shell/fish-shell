...
complete -c python3 -s h -l help -d "Display help and exit"
...
complete -c python3 -s V -d "Display version and exit"
...
complete -c python3 -fa "(__fish_complete_suffix .py)"
complete -c python3 -fa '-' -d 'Read program from stdin'
