...
function __ghoti_nvram_variables
    command nvram -p
end
...
complete -c nvram -s d -x -a '(__ghoti_nvram_variables)' -d 'Deletes the named firmware variable'
complete -c nvram -s c -f -d 'Delete all of the firmware variable'
complete -c nvram -x -a '(__ghoti_nvram_variables)'
