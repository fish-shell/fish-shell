...
complete -f -c git -n '__fish_git_using_command restore' -s W -l worktree -d 'Restore the working tree (default)'
complete -f -c git -n '__fish_git_using_command restore' -s S -l staged -d 'Restore the index'
complete -f -c git -n '__fish_git_using_command restore' -s q -l quiet -d 'Suppress messages'
complete -f -c git -n '__fish_git_using_command restore' -l progress -d 'Report progress status to standard error (default)'
complete -f -c git -n '__fish_git_using_command restore' -l no-progress -d 'Do not report progress status to standard error'
...
complete -f -c git -n '__fish_git_using_command restore' -l 'conflict=merge' -d 'Same as --merge, but specify \'merge\' as the style of the conflicting hunks (default)'
complete -f -c git -n '__fish_git_using_command restore' -l 'conflict=diff3' -d 'Same as --merge, but specify \'diff3\' as the style of the conflicting hunks'
...
complete -f -c git -n '__fish_git_using_command restore' -l ignore-skip-worktree-bits -d 'Ignore the sparse patterns and unconditionally restore files in <pathspec>'
...
complete -f -c git -n '__fish_git_using_command switch' -l 'conflict=merge' -d 'Same as --merge, but specify \'merge\' as the style of the conflicting hunks (default)'
complete -f -c git -n '__fish_git_using_command switch' -l 'conflict=diff3' -d 'Same as --merge, but specify \'diff3\' as the style of the conflicting hunks'
complete -f -c git -n '__fish_git_using_command switch' -s q -l quiet -d 'Suppress messages'
complete -f -c git -n '__fish_git_using_command switch' -l progress -d 'Report progress status to standard error (default)'
complete -f -c git -n '__fish_git_using_command switch' -l no-progress -d 'Do not report progress status to standard error'
