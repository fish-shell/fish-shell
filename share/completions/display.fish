...
complete -c display -o transparent-color -d 'Transparent color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c display -o window -d 'Display image to background of this window [id]' -xa 'root (__ghoti_print_xwindows)'
...
complete -c display -o log -d 'Format of debugging information [format]' -xa '(__ghoti_complete_convert_options format)'
