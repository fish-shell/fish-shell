...
complete -c mogrify -o background -d 'Background color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c mogrify -o bordercolor -d 'Border color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c mogrify -o encoding -d 'Encoding type [type text]' -xa '(__ghoti_print_encodings)'
complete -c mogrify -o endian -d 'Endianness (MSB or LSB) of the image [type]' -xa '(mogrify -list endian)'
complete -c mogrify -o family -d 'Render text with this font family [name]' -xa '(__ghoti_complete_convert_options family)'
complete -c mogrify -o fill -d 'Color to use when filling a graphic primitive [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c mogrify -o font -d 'Render text with this font [name]' -xa '(__ghoti_complete_convert_options font)'
complete -c mogrify -o format -d 'Image format type [type]' -xa '(__ghoti_complete_convert_options type)'
...
complete -c mogrify -o mattecolor -d 'Frame color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c mogrify -o stroke -d 'Graphic primitive stroke color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c mogrify -o transparent-color -d 'Transparent color [color]' -xa '(__ghoti_complete_convert_options color)'
complete -c mogrify -o undercolor -d 'Annotation bounding box color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c mogrify -o opaque -d 'Change this color to the fill color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c mogrify -o transparent -d 'Make this color transparent within the image [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c mogrify -o log -d 'Format of debugging information [format]' -xa '(__ghoti_complete_convert_options format)'
