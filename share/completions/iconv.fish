...
complete -c iconv -s f -l from-code -d "Convert from specified encoding" -x -a "(__ghoti_print_encodings)"
complete -c iconv -s t -l to-code -d "Convert to specified encoding" -x -a "(__ghoti_print_encodings)"
