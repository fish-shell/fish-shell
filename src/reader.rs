...
use crate::output::TerminalCommand::DecrstAlternateScreenBuffer;
use crate::output::TerminalCommand::DecrstMouseTracking;
use crate::output::TerminalCommand::DecrstSynchronizedUpdate;
use crate::output::TerminalCommand::DecsetAlternateScreenBuffer;
use crate::output::TerminalCommand::DecsetShowCursor;
use crate::output::TerminalCommand::DecsetSynchronizedUpdate;
use crate::output::TerminalCommand::QueryCursorPosition;
...
fn read_i(parser: &Parser) {
    ...
    while !check_exit_loop_maybe_warning(Some(&mut data)) {
        ...
        BufferedOutputter::new(Outputter::stdoutput()).write_command(
            crate::output::TerminalCommand::Osc133CommandFinished(parser.get_last_status()),
        );
