...
complete -f -c connmanctl -n "fish_is_nth_token 2; and contains -- (commandline -opc)[2] enable" -a "(__fish_print_connman_technologies) offline"
complete -f -c connmanctl -n "test (count (commandline -opc)) -lt 2" -a disable -d "Disables given technology or offline mode"
complete -f -c connmanctl -n "fish_is_nth_token 2; and contains -- (commandline -opc)[2] disable" -a "(__fish_print_connman_technologies) offline"
...
complete -f -c connmanctl -n "fish_is_nth_token 2; and contains -- (commandline -opc)[2] tether" -a "(__fish_print_connman_technologies)"
complete -f -c connmanctl -n "fish_is_nth_token 3; and contains -- (commandline -opc)[2] tether" -a "on off"
complete -f -c connmanctl -n "test (count (commandline -opc)) -lt 2" -a services -d "Display services"
complete -f -c connmanctl -n "fish_is_nth_token 2; and contains -- (commandline -opc)[2] services" -a "(__fish_print_connman_services)"
...
complete -f -c connmanctl -n "fish_is_nth_token 2; and contains -- (commandline -opc)[2] scan" -a "(__fish_print_connman_technologies)"
complete -f -c connmanctl -n "test (count (commandline -opc)) -lt 2" -a connect -d "Connect a given service or peer"
complete -f -c connmanctl -n "fish_is_nth_token 2; and contains -- (commandline -opc)[2] connect" -a "(__fish_print_connman_services)"
complete -f -c connmanctl -n "test (count (commandline -opc)) -lt 2" -a disconnect -d "Disconnect a given service or peer"
complete -f -c connmanctl -n "fish_is_nth_token 2; and contains -- (commandline -opc)[2] disconnect" -a "(__fish_print_connman_services)"
...
complete -f -c connmanctl -n "fish_is_nth_token 2; and contains -- (commandline -opc)[2] vpnconnections" -a "(__fish_print_connman_vpnconnections)"
complete -f -c connmanctl -n "test (count (commandline -opc)) -lt 2" -a session -d "Enable or disable a session"
complete -f -c connmanctl -n "fish_is_nth_token 2; and contains -- (commandline -opc)[2] session" -a "on off connect disconnect config"
