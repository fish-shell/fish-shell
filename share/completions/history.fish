...
set -l __ghoti_history_all_commands search delete save merge clear clear-session
...
complete -c history -n '__ghoti_seen_subcommand_from search delete; or not __ghoti_seen_subcommand_from $__ghoti_history_all_commands' \
...
complete -c history -n '__ghoti_seen_subcommand_from search; or not __ghoti_seen_subcommand_from $__ghoti_history_all_commands' \
...
# interactively.
complete -f -c history -n "not __ghoti_seen_subcommand_from $__ghoti_history_all_commands" \
