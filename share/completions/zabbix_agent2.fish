...
complete -c zabbix_agent2 -s c -l config -d "Use the alternate config-file instead of the default one."
complete -c zabbix_agent2 -r -f -s R -l runtime-control -a "$runtime" -d "Perform administrative functions according to runtime-option."
