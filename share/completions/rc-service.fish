...
complete -c rc-service -n "test (__fish_number_of_cmd_args_wo_opts) = 1" -xa "(__fish_print_service_names)" --description "Service name"

# The second argument is what action to take with the service
complete -c rc-service -n "test (__fish_number_of_cmd_args_wo_opts) -gt 1" -xa "start stop restart"
