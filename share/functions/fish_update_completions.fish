function fish_update_completions --description "Update man-page based completions"
    ...
    # display progress.
    set -l update_args -B $__fish_data_dir/tools/create_manpage_completions.py --manpath --cleanup-in ~/.config/fish/generated_completions --progress --fish-data-dir $__fish_data_dir $argv
