...
complete -c ansible-playbook -s D -l diff -f -d "Show differences in files and templates"
...
complete -c ansible-playbook -l skip-tags -r -d "Exclude plays and tasks if tags match"
...
complete -c ansible-playbook -l syntax-check -f -d "Perform syntax check on the playbook"
...
complete -c ansible-playbook -s v -l verbose -f -d "Verbose mode"
complete -c ansible-playbook -l version -f -d "Display version"
