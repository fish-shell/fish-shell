...
complete -c dive -l highestUserWastedPercent -r -n "__ghoti_seen_argument -l ci" -d "Highest allowable percentage of bytes wasted"
complete -c dive -l highestWastedBytes -r -n "__ghoti_seen_argument -l ci" -d "Highest allowable bytes wasted"
...
complete -c dive -n __ghoti_use_subcommand -xa build -d "Build and analyze a Docker image from a Dockerfile"
complete -c dive -n __ghoti_use_subcommand -xa help -d "Help about any command"
complete -c dive -n __ghoti_use_subcommand -xa version -d "Print the version number and exit"
complete -c dive -n "__ghoti_seen_subcommand_from help" -a "build help version"
