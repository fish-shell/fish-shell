...
complete -c lscpu -l extended -s e -x -a '(__ghoti_append , $__ghoti_lscpu_columns)' -d "Print out an extended readable format"
complete -c lscpu -l parse -s p -x -a '(__ghoti_append , $__ghoti_lscpu_columns)' -d "Print out a parseble format"
