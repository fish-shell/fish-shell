...
fn main() -> miette::Result<()> {
    ...
    let ghoti_src_dir = format!("{}/{}", rust_dir, "../src/");
    ...
    let autocxx_gen_dir = std::env::var("FISH_AUTOCXX_GEN_DIR")
        .unwrap_or(format!("{}/{}", ghoti_build_dir, "ghoti-autocxx-gen/"));
    ...
    cxx_build::bridges(&source_files)
        ...
        .include(&ghoti_src_dir)
        .include(&ghoti_build_dir) // For config.h
    ...
    let include_paths = [&ghoti_src_dir, &ghoti_build_dir, &cxx_include_dir];
