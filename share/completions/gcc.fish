...
complete -c gcc -o lm -d 'You need this special case of the -l option in order to link math.h'
complete -c gcc -o lz -d 'You need this special case of the -l option in order to link zlib'
complete -c gcc -o lrt -d 'You need this special case of the -l option in order to link realtime extensions library'
