...
complete -c stream -o transparent-color -d 'Transparent color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c stream -o log -d 'Format of debugging information [format]' -xa '(__ghoti_complete_convert_options format)'
