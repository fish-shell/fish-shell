function __ghoti_cryptenroll_pkcs11_devices
...
function __ghoti_cryptenroll_fido2_devices
...
function __ghoti_cryptenroll_tpm2_devices
...
function __ghoti_cryptenroll_complete_wipe
...
complete -c systemd-cryptenroll -xa "(__ghoti_complete_blockdevice)"
...
complete -c systemd-cryptenroll -l pkcs11-token-uri -kxa "(__ghoti_cryptenroll_pkcs11_devices)" -d "Enroll a PKCS#11 security token or smartcard"
complete -c systemd-cryptenroll -l fido2-device -kxa "(__ghoti_cryptenroll_fido2_devices)" -d "Enroll a FIDO2 security token"
...
complete -c systemd-cryptenroll -l tpm2-device -kxa "(__ghoti_cryptenroll_tpm2_devices)" -d "Enroll a TPM2 security chip"
complete -c systemd-cryptenroll -l tpm2-pcrs -x -d "Bind the enrollment of TPM2 device to speficied PCRs"
complete -c systemd-cryptenroll -l wipe-slot -kxa "(__ghoti_complete_list , __ghoti_cryptenroll_complete_wipe)" -d "Wipes one or more LUKS2 key slots"
