function help --description 'Show help for the ghoti shell'
    ...
    if not set -q ghoti_browser[1]
        ...
        printf (_ 'Please try `BROWSER=some_browser help`, `man ghoti-doc`, or `man ghoti-tutorial`.\n\n') >&2
        return 1
    end
    ...
    set -l for_bash_pages arithmetic-expansion bash-command-substitutions blocks-and-loops builtins-and-other-commands command-substitutions ghoti-for-bash-users heredocs process-substitution prompts quoting special-variables string-manipulation subshells test-test variables wildcards-globs
    set -l faqpages faq-ssh-interactive faq-unicode faq-uninstalling frequently-asked-questions how-can-i-use-as-a-shortcut-for-cd how-do-i-change-the-greeting-message how-do-i-check-whether-a-variable-is-defined how-do-i-check-whether-a-variable-is-not-empty how-do-i-customize-my-syntax-highlighting-colors how-do-i-get-the-exit-status-of-a-command how-do-i-make-ghoti-my-default-shell how-do-i-run-a-command-every-login-what-s-ghoti-s-equivalent-to-bashrc-or-profile how-do-i-run-a-command-from-history how-do-i-run-a-subcommand-the-backtick-doesn-t-work how-do-i-set-my-prompt how-do-i-set-or-clear-an-environment-variable i-accidentally-entered-a-directory-path-and-ghoti-changed-directory-what-happened i-m-getting-weird-graphical-glitches-a-staircase-effect-ghost-characters-cursor-in-the-wrong-position i-m-seeing-weird-output-before-each-prompt-when-using-screen-what-s-wrong my-command-pkg-config-gives-its-output-as-a-single-long-string my-command-prints-no-matches-for-wildcard-but-works-in-bash the-open-command-doesn-t-work uninstalling-ghoti what-is-the-equivalent-to-this-thing-from-bash-or-other-shells where-can-i-find-extra-tools-for-ghoti why-does-my-prompt-show-a-i why-doesn-t-history-substitution-etc-work why-doesn-t-set-ux-exported-universal-variables-seem-to-work why-won-t-ssh-scp-rsync-connect-properly-when-ghoti-is-my-login-shell
    ...
    switch "$ghoti_help_item"
        ...
        case ":"
            set ghoti_help_page "cmds/true.html"
        case "["
            set ghoti_help_page "cmds/test.html"
        case globbing
            set ghoti_help_page "language.html#expand"
        case 'completion-*'
        ...
        case releasenotes
            set ghoti_help_page relnotes.html
        case completions
            set ghoti_help_page completions.html
        case commands
            set ghoti_help_page commands.html
        case faq
            set ghoti_help_page faq.html
        case ghoti-for-bash-users
            set ghoti_help_page ghoti_for_bash_users.html
        case $faqpages
            set ghoti_help_page "faq.html#$ghoti_help_item"
        case $for_bash_pages
            set ghoti_help_page "ghoti_for_bash_users.html#$ghoti_help_item"
        case $langpages
            set ghoti_help_page "language.html#$ghoti_help_item"
        case $interactivepages
            set ghoti_help_page "interactive.html#$ghoti_help_item"
        case $tutpages
            set ghoti_help_page "tutorial.html#$ghoti_help_item"
        case (builtin -n) (__ghoti_print_commands)
            # If the docs aren't installed, __ghoti_print_commands won't print anything
        ...
        case "*"
            printf (_ "%s: no ghoti help topic '%s', try 'man %s'\n") help $ghoti_help_item $ghoti_help_item
            return 1
    end
    ...
    string match -q '*garcon-url-handler*' $ghoti_browser[1]
    and set -l chromeos_linux_garcon

    set -l page_url
    if test -f $__ghoti_help_dir/index.html; and not set -lq chromeos_linux_garcon
    ...
    if string match -qr 'powershell\.exe$|cmd\.exe$' -- $ghoti_browser[1]
