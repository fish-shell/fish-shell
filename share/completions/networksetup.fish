...
function __fish_networksetup_services
    networksetup -listallnetworkservices | tail -n +2 | string replace -r '^\*\s*' ''
end

function __fish_networksetup_hardwareports
    networksetup -listallhardwareports | string replace -rf '^Hardware Port: ' ''
end

function __fish_networksetup_devices
    networksetup -listallhardwareports | string replace -rf '^Device: ' ''
end
...
set -l svc_verbs getadditionalroutes getautoproxyurl getdnsservers getinfo \
    getnetworkserviceenabled getproxyautodiscovery getproxybypassdomains getsearchdomains \
    getsecurewebproxy getsocksfirewallproxy getv6additionalroutes getwebproxy \
    duplicatenetworkservice removenetworkservice renamenetworkservice set6to4automatic \
    set6to4manual setadditionalroutes setautoproxystate setautoproxyurl setbootp setdhcp \
    setdnsservers setmanual setmanualwithdhcprouter setnetworkserviceenabled setproxyautodiscovery \
    setproxybypassdomains setsearchdomains setsecurewebproxy setsecurewebproxystate \
    setsocksfirewallproxy setsocksfirewallproxystate setv4off setv6additionalroutes setv6automatic \
    setv6LinkLocal setv6manual setv6off setwebproxy setwebproxystate ordernetworkservices
complete -c networksetup -x -n "contains -- (__fish_networksetup_verb) $svc_verbs" -a '(__fish_networksetup_services)'

set -l port_verbs getmacaddress getmedia getMTU listvalidmedia listvalidMTUrange setmedia setMTU \
    setMTUAndMediaAutomatically
complete -c networksetup -x -n "contains -- (__fish_networksetup_verb) $port_verbs" -a '(__fish_networksetup_hardwareports)'
complete -c networksetup -x -n "contains -- (__fish_networksetup_verb) $port_verbs" -a '(__fish_networksetup_devices)'
...
set -l dev_verbs getairportnetwork getairportpower setairportnetwork setairportpower \
    ...
    removepreferredwirelessnetwork listpreferredwirelessnetworks isBondSupported addDeviceToBond \
    removeDeviceFromBond createpppoeservice
complete -c networksetup -x -n "contains -- (__fish_networksetup_verb) $dev_verbs" -a '(__fish_networksetup_devices)'

set -l loc_verbs deletelocation switchtolocation
complete -c networksetup -x -n "contains -- (__fish_networksetup_verb) $loc_verbs" -a '(__fish_networksetup_locations)'

set -l bond_verbs deleteBond showBondStatus
complete -c networksetup -x -n "contains -- (__fish_networksetup_verb) $bond_verbs" -a '(__fish_networksetup_bonds)'
...
complete -c networksetup -x -n "contains -- (__fish_networksetup_verb) $pppoe_verbs" -a '(__fish_networksetup_pppoe)'
