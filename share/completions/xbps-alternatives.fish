...
complete -c $progname -s l -n "not __ghoti_contains_opt -s s" -d 'Lists all current alternative groups or only from PKG, or just a specific group with -g.'
complete -c $progname -s s -n "not __ghoti_contains_opt -s l" -d 'Set alternative groups specified by PKG or just a specific group with -g.'
