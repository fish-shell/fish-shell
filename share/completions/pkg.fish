...
complete -c pkg -n __fish_use_subcommand -xa annotate   -d "Modify annotations on packages"
complete -c pkg -n __fish_use_subcommand -xa audit      -d "Audit installed packages"
complete -c pkg -n __fish_use_subcommand -xa autoremove -d "Delete unneeded packages"
complete -c pkg -n __fish_use_subcommand -xa backup     -d "Dump package database"
complete -c pkg -n __fish_use_subcommand -xa check      -d "Check installed packages"
complete -c pkg -n __fish_use_subcommand -xa clean      -d "Clean local cache"
complete -c pkg -n __fish_use_subcommand -xa convert    -d "Convert package from pkg_add format"
complete -c pkg -n __fish_use_subcommand -xa create     -d "Create a package"
complete -c pkg -n __fish_use_subcommand -xa delete     -d "Remove a package"
complete -c pkg -n __fish_use_subcommand -xa fetch      -d "Download a remote package"
complete -c pkg -n __fish_use_subcommand -xa info       -d "List installed packages"
complete -c pkg -n __fish_use_subcommand -xa install    -d "Install packages"
complete -c pkg -n __fish_use_subcommand -xa lock       -d "Prevent package modification"
complete -c pkg -n __fish_use_subcommand -xa plugins    -d "List package manager plugins"
complete -c pkg -n __fish_use_subcommand -xa query      -d "Query installed packages"
complete -c pkg -n __fish_use_subcommand -xa register   -d "Register a package in a database"
complete -c pkg -n __fish_use_subcommand -xa remove     -d "Remove a package"
complete -c pkg -n __fish_use_subcommand -xa repo       -d "Create package repository"
complete -c pkg -n __fish_use_subcommand -xa rquery     -d "Query information for remote repositories"
complete -c pkg -n __fish_use_subcommand -xa search     -d "Find packages"
complete -c pkg -n __fish_use_subcommand -xa set        -d "Modify package information in database"
complete -c pkg -n __fish_use_subcommand -xa shell      -d "Open a SQLite shell"
complete -c pkg -n __fish_use_subcommand -xa shlib      -d "Display packages linking to shared library"
complete -c pkg -n __fish_use_subcommand -xa stats      -d "Display package statistics"
complete -c pkg -n __fish_use_subcommand -xa unlock     -d "Stop preventing package modification"
complete -c pkg -n __fish_use_subcommand -xa update     -d "Update remote repositories"
complete -c pkg -n __fish_use_subcommand -xa updating   -d "Display UPDATING entries"
complete -c pkg -n __fish_use_subcommand -xa upgrade    -d "Upgrade packages"
complete -c pkg -n __fish_use_subcommand -xa version    -d "Show package versions"
complete -c pkg -n __fish_use_subcommand -xa which      -d "Check which package provides a file"
