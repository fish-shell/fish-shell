...
complete -c composite -o encoding -d 'Encoding type [type text]' -xa '(__ghoti_print_encodings)'
...
complete -c composite -o font -d 'Render text with this font [name]' -xa '(__ghoti_complete_convert_options font)'
...
complete -c composite -o transparent-color -d 'Transparent color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c composite -o bordercolor -d 'Border color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c composite -o log -d 'Format of debugging information [format]' -xa '(__ghoti_complete_convert_options format)'
