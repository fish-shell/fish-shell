...
use crate::common::{escape, Cleanup};
...
impl Autoload {
    ...
    pub fn perform_autoload(path: &wstr, parser: &mut Parser) {
        ...
        let mut parser = Cleanup::new(parser, |parser| parser.set_last_statuses(prev_statuses));
