...
complete -c dpkg -s i -l install -d 'Install .deb package' -k -xa '(__ghoti_complete_suffix .deb)'
complete -c dpkg -l unpack -d 'Unpack .deb package' -k -xa '(__ghoti_complete_suffix .deb)'
...
# dpkg-deb options
complete -c dpkg -s b -l build -d 'Build package from directory' -xa '(__ghoti_complete_directories (commandline -ct))'
complete -c dpkg -s c -l contents -d 'List contents of .deb' -k -xa '(__ghoti_complete_suffix .deb)'
complete -c dpkg -s I -l info -d 'Show .deb information' -k -xa '(__ghoti_complete_suffix .deb)'
