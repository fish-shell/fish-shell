...
if test "$gnu_linux" -eq 1
    ...
    complete -c ps -s C -d "Select by command" -ra '(__ghoti_complete_list , __ghoti_complete_proc)'
    ...
    complete -c ps -s s -l sid -d "Select by session ID" -x -a "(__ghoti_complete_list , __ghoti_complete_pids)"
    complete -c ps -s T -d "Show threads. With SPID"
    complete -c ps -s u -l user -d "Select by user" -x -a "(__ghoti_complete_list , __ghoti_complete_users)"
    ...
    complete -c ps -l ppid -d "Select by parent PID" -x -a "(__ghoti_complete_list , __ghoti_complete_pids)"
...
complete -c ps -s G -lgroup$bsd_null -d "Select by group" -x -a "(__ghoti_complete_list , __ghoti_complete_groups)"
complete -c ps -s U -luser$bsd_null -d "Select by user" -x -a "(__ghoti_complete_list , __ghoti_complete_users)"
complete -c ps -s p -lpid$bsd_null -d "Select by PID" -x -a "(__ghoti_complete_list , __ghoti_complete_pids)"
