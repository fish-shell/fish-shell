...
complete -c s3cmd -n "__initial_command" -a 'la' --description 'List all object in all buckets'
complete -c s3cmd -n "__initial_command" -a 'put' --description 'Put file into bucket'
complete -c s3cmd -n "__initial_command" -a 'get' --description 'Get file from bucket'
complete -c s3cmd -n "__initial_command" -a 'del' --description 'Delete file from bucket'
complete -c s3cmd -n "__initial_command" -a 'rm' --description 'Delete file from bucket (alias for del)'
complete -c s3cmd -n "__initial_command" -a 'restore' --description 'Restore file from Glacier storage'
complete -c s3cmd -n "__initial_command" -a 'sync' --description 'Synchronize a directory tree to S3'
complete -c s3cmd -n "__initial_command" -a 'du' --description 'Disk usage by buckets'
complete -c s3cmd -n "__initial_command" -a 'info' --description 'Get various information about Buckets or Files'
complete -c s3cmd -n "__initial_command" -a 'cp' --description 'Copy object'
complete -c s3cmd -n "__initial_command" -a 'modify' --description 'Modify object metadata'
complete -c s3cmd -n "__initial_command" -a 'mv' --description 'Move object'
complete -c s3cmd -n "__initial_command" -a 'setacl' --description 'Modify Access control list for Bucket or Files'
complete -c s3cmd -n "__initial_command" -a 'setpolicy' --description 'Modify Bucket Policy'
complete -c s3cmd -n "__initial_command" -a 'delpolicy' --description 'Delete Bucket Policy'
complete -c s3cmd -n "__initial_command" -a 'setcors' --description 'Modify Bucket CORS'
complete -c s3cmd -n "__initial_command" -a 'delcors' --description 'Delete Bucket CORS'
complete -c s3cmd -n "__initial_command" -a 'payer' --description 'Modify Bucket Requester Pays policy'
complete -c s3cmd -n "__initial_command" -a 'multipart' --description 'Show multipart uploads'
complete -c s3cmd -n "__initial_command" -a 'abortmp' --description 'Abort a multipart upload'
complete -c s3cmd -n "__initial_command" -a 'listmp' --description 'List parts of a multipart upload'
complete -c s3cmd -n "__initial_command" -a 'accesslog' --description 'Enable/disable bucket access logging'
complete -c s3cmd -n "__initial_command" -a 'sign' --description 'Sign arbitrary string using the secret key'
complete -c s3cmd -n "__initial_command" -a 'signurl' --description 'Sign an S3 URL to provide limited public access with expiry'
complete -c s3cmd -n "__initial_command" -a 'fixbucket' --description 'Fix invalid file names in a bucket'
complete -c s3cmd -n "__initial_command" -a 'ws-create' --description 'Create Website from bucket'
complete -c s3cmd -n "__initial_command" -a 'ws-delete' --description 'Delete Website'
complete -c s3cmd -n "__initial_command" -a 'ws-info' --description 'Info about Website'
complete -c s3cmd -n "__initial_command" -a 'expire' --description 'Set or delete expiration rule for the bucket'
complete -c s3cmd -n "__initial_command" -a 'setlifecycle' --description 'Upload a lifecycle policy for the bucket'
complete -c s3cmd -n "__initial_command" -a 'dellifecycle' --description 'Remove a lifecycle policy for the bucket'
complete -c s3cmd -n "__initial_command" -a 'cflist' --description 'List CloudFront distribution points'
complete -c s3cmd -n "__initial_command" -a 'cfinfo' --description 'Display CloudFront distribution point parameters'
complete -c s3cmd -n "__initial_command" -a 'cfcreate' --description 'Create CloudFront distribution point'
complete -c s3cmd -n "__initial_command" -a 'cfdelete' --description 'Delete CloudFront distribution point'
complete -c s3cmd -n "__initial_command" -a 'cfmodify' --description 'Change CloudFront distribution point parameters'
complete -c s3cmd -n "__initial_command" -a 'cfinvalinfo' --description 'Display CloudFront invalidation request(s) status'
...
complete -c s3cmd -l continue --description 'Resume partially downloaded file' -n "__prev_tokens get"
...
complete -c s3cmd -l skip-existing --description 'Skip existing files at destination' -n "__prev_tokens get sync"
complete -c s3cmd -s r -l recursive --description 'Upload/download/delete recursively'
complete -c s3cmd -l check-md5 --description 'Check MD5 sums (default)' -n "__prev_tokens sync"
complete -c s3cmd -l no-check-md5 --description 'Skip MD5 sum check' -n "__prev_tokens sync"
...
complete -c s3cmd -l delete-removed --description 'Delete objects not found locally' -n "__prev_tokens sync"
complete -c s3cmd -l no-delete-removed --description 'Don\'t delete dest objects'
complete -c s3cmd -l delete-after --description 'Delete after upload' -n "__prev_tokens sync"
complete -c s3cmd -l max-delete --description 'Delete no more than NUM files' -n "__prev_tokens del sync"
complete -c s3cmd -l limit --description 'Max objects per response' -n "__prev_tokens ls la"
complete -c s3cmd -l add-destination --description 'Additional parallel upload'
complete -c s3cmd -l delete-after-fetch --description 'Delete remotely after fetch' -n "__prev_tokens get sync"
...
complete -c s3cmd -l reduced-redundancy -l rr --description 'Store with reduced redundancy' -n "__prev_tokens put cp mv"
complete -c s3cmd -l no-reduced-redundancy -l no-rr --description 'Store without reduced redundancy' -n "__prev_tokens put cp mv"
complete -c s3cmd -l storage-class --description 'Store with STANDARD, STANDARD_IA, or REDUCED_REDUNDANCY'
complete -c s3cmd -l access-logging-target-prefix --description 'Prefix for access logs' -n "__prev_tokens cfmodify accesslog"
complete -c s3cmd -l no-access-logging --description 'Disable access logging' -n "__prev_tokens cfmodify accesslog"
...
complete -c s3cmd -l list-md5 --description 'Include MD5 sums in bucket listings' -n "__prev_tokens ls"
complete -c s3cmd -s H -l human-readable-sizes --description 'Print sizes in human-readable form'
complete -c s3cmd -l ws-index --description 'Name of index-document' -n "__prev_tokens ws-create"
complete -c s3cmd -l ws-error --description 'Name of error-document' -n "__prev_tokens ws-create"
complete -c s3cmd -l expiry-date --description 'When expiration rule takes effect' -n "__prev_tokens expire"
complete -c s3cmd -l expiry-days --description 'Days to expire' -n "__prev_tokens expire"
complete -c s3cmd -l expiry-prefix --description 'Apply expiry to objects matching prefix' -n "__prev_tokens expire"
...
complete -c s3cmd -l enable --description 'Enable CloudFront distribution' -n "__prev_tokens cfmodify"
complete -c s3cmd -l disable --description 'Disable CloudFront distribution' -n "__prev_tokens cfmodify"
complete -c s3cmd -l cf-invalidate --description 'Invalidate CloudFront file' -n "__prev_tokens cfmodify"
complete -c s3cmd -l cf-invalidate-default-index --description 'Invalidate default index' -n "__prev_tokens cfmodify"
complete -c s3cmd -l cf-no-invalidate-default-index-root --description 'Don\'t invalidate default index' -n "__prev_tokens cfmodify"
complete -c s3cmd -l cf-add-cname --description 'Add CNAME to CloudFront distribution' -n "__prev_tokens cfcreate cfmodify"
complete -c s3cmd -l cf-remove-cname --description 'Remove CNAME from CloudFront distribution' -n "__prev_tokens cfmodify"
complete -c s3cmd -l cf-comment --description 'Set COMMENT for CloudFront distribution' -n "__prev_tokens cfcreate cfmodify"
complete -c s3cmd -l cf-default-root-object --description 'Set default root object' -n "__prev_tokens cfcreate cfmodify"
...
complete -c s3cmd -s l -l long-listing --description 'Produce long listing' -n "__prev_tokens ls"
