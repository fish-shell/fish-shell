...
complete -c git -n '__fish_git_using_command diff show range-diff' -s G -d 'Look for differences where <regex> matches the patch text''s added/removed lines'
...
complete -c git -n '__fish_git_using_command filter-branch' -s f -l force -d 'Force filter branch to start even w/ refs in refs/original or existing temp dir'
...
complete -c git -n '__fish_git_using_command log' -l all -d 'Pretend that all refs in refs/ are listed on the cmd line as <commit>'
complete -f -c git -n '__fish_git_using_command log' -l branches -d 'Pretend that all refs in refs/heads are listed on the cmd line as <commit>'
complete -f -c git -n '__fish_git_using_command log' -l tags -d 'Pretend that all refs in ref/tags are listed on the cmd line as <commit>'
complete -f -c git -n '__fish_git_using_command log' -l remotes -d 'Pretend that all refs in refs/remotes are listed on the cmd line as <commit>'
complete -x -c git -n '__fish_git_using_command log' -l glob -d 'Pretend that all refs matching shell glob are listed on the cmd line as <commit>'
complete -x -c git -n '__fish_git_using_command log' -l exclude -d 'Do not include refs matching given glob pattern'
complete -c git -n '__fish_git_using_command log' -l reflog -d 'Pretend that all objs included in reflogs are listed on the cmd line as <commit>'
...
complete -f -c git -n '__fish_git_using_command format-patch' -l textconv -d "Allow external txt conv filters for binary files (Resulting diff is unappliable)"
