...
complete --command fish_opt --short-option s --long-option short --require-parameter --description 'Specify short option'
complete --command fish_opt --short-option l --long-option long --require-parameter --description 'Specify long option'
