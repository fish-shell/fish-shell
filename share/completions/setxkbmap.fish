function __ghoti_complete_setxkbmap --description 'Complete setxkb options' --argument-names what
...
complete -c setxkbmap -o I -d 'Add <dir> to list of directories to be used' -xa '(__ghoti_complete_directories)'
...
complete -c setxkbmap -o layout -d 'Specifies layout used to choose component names' -xa "(__ghoti_complete_setxkbmap layout)"
complete -c setxkbmap -o model -d 'Specifies model used to choose component names' -xa "(__ghoti_complete_setxkbmap model)"
complete -c setxkbmap -o option -d 'Adds an option used to choose component names' -xa "(__ghoti_complete_list , '__ghoti_complete_setxkbmap option')"
...
complete -c setxkbmap -o variant -d 'Specifies layout variant used to choose component names' -xa "(__ghoti_complete_setxkbmap variant)"
