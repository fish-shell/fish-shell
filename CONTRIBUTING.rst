...
If you build fish locally (``cargo build``), machine-readable binary files will be generated
automatically (if you have the ``msgfmt`` utility installed (comes as part of ``gettext``)).
If everything is installed, you should be able to generate/modify a PO file,
compile fish, and when the new fish binary runs, it should make use of the translations you just
added.
