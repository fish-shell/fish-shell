function __ghoti_print_firewalld_zones --description "Print list of predefined firewalld zones"
    firewall-cmd --get-zones | string split " "
end

function __ghoti_print_firewalld_policies --description "Print list of predefined firewalld policies"
    firewall-cmd --get-policies | string split " "
end

function __ghoti_print_firewalld_services --description "Print list of predefined firewalld services"
    firewall-cmd --get-services | string split " "
end

function __ghoti_print_firewalld_icmptypes --description "Print list of ICMP types supported by firewalld"
    firewall-cmd --get-icmptypes | string split " "
end

function __ghoti_print_firewalld_helpers --description "Print list of predefined firewalld helpers"
    firewall-cmd --get-helpers | string split " "
end

function __ghoti_print_firewalld_protocols --description "Print list of protocols supported by firewalld"
...
complete -c firewall-cmd -l set-default-zone -xa "(__ghoti_print_firewalld_zones)" -d "Set default zone for connections and interfaces"
...
complete -c firewall-cmd -l get-zone-of-interface -xa "(__ghoti_print_interfaces)" -d "Print the name of the zone the interface is bound to"
complete -c firewall-cmd -l get-zone-of-source -x -d "Print the name of the zone the source is bound to"
complete -c firewall-cmd -l info-zone -xa "(__ghoti_print_firewalld_zones)" -d "Print information about the zone"
...
complete -c firewall-cmd -l delete-zone -xa "(__ghoti_print_firewalld_zones)" -d "Delete an existing permanent zone"
complete -c firewall-cmd -l load-zone-defaults -xa "(__ghoti_print_firewalld_zones)" -d "Load zone default settings"
complete -c firewall-cmd -l path-zone -xa "(__ghoti_print_firewalld_zones)" -d "Print path of the zone configuration file"

# Policy Options
complete -c firewall-cmd -l get-policies -d "Print predefined policies"
complete -c firewall-cmd -l info-policy -xa "(__ghoti_print_firewalld_policies)" -d "Print information about the policy"
...
complete -c firewall-cmd -l path-policy -xa "(__ghoti_print_firewalld_policies)" -d "Print path of the policy configuration file"
complete -c firewall-cmd -l delete-policy -xa "(__ghoti_print_firewalld_policies)" -d "Delete an existing permanent policy"
complete -c firewall-cmd -l load-policy-defaults -xa "(__ghoti_print_firewalld_policies)" -d "Load the shipped defaults for a policy"

# Options to Adapt and Query Zones and Policies
complete -c firewall-cmd -l zone -xa "(__ghoti_print_firewalld_zones)" -d "Apply option to this zone"
complete -c firewall-cmd -l policy -xa "(__ghoti_print_firewalld_policies)" -d "Apply option to this policy"
...
complete -c firewall-cmd -l add-service -xa "(__ghoti_print_firewalld_services)" -d "Add a service"
complete -c firewall-cmd -l remove-service -xa "(__ghoti_print_firewalld_services)" -d "Remove a service"
complete -c firewall-cmd -l query-service -xa "(__ghoti_print_firewalld_services)" -d "Return whether service has been added"
...
complete -c firewall-cmd -l add-icmp-block -xa "(__ghoti_print_firewalld_icmptypes)" -d "Add an ICMP block for icmptype"
complete -c firewall-cmd -l remove-icmp-block -xa "(__ghoti_print_firewalld_icmptypes)" -d "Remove the ICMP block for icmptype"
complete -c firewall-cmd -l query-icmp-block -xa "(__ghoti_print_firewalld_icmptypes)" -d "Return whether an ICMP block for icmptype has been added"
...
complete -c firewall-cmd -l add-ingress-zone -xa "(__ghoti_print_firewalld_zones) HOST ANY" -d "Add an ingress zone"
complete -c firewall-cmd -l remove-ingress-zone -xa "(__ghoti_print_firewalld_zones) HOST ANY" -d "Remove an ingress zone"
complete -c firewall-cmd -l query-ingress-zone -xa "(__ghoti_print_firewalld_zones) HOST ANY" -d "Return whether zone has been added"
complete -c firewall-cmd -l list-egress-zones -d "List egress zones added"
complete -c firewall-cmd -l add-egress-zone -xa "(__ghoti_print_firewalld_zones) HOST ANY" -d "Add an egress zone"
complete -c firewall-cmd -l remove-egress-zone -xa "(__ghoti_print_firewalld_zones) HOST ANY" -d "Remove an egress zone"
complete -c firewall-cmd -l query-egress-zone -xa "(__ghoti_print_firewalld_zones) HOST ANY" -d "Return whether zone has been added"

# Options to Handle Bindings of Interfaces
complete -c firewall-cmd -l list-interfaces -d "List interfaces that are bound to zone"
complete -c firewall-cmd -l add-interface -xa "(__ghoti_print_interfaces)" -d "Bind interface to zone"
complete -c firewall-cmd -l change-interface -xa "(__ghoti_print_interfaces)" -d "Change to which zone interface is bound"
complete -c firewall-cmd -l query-interface -xa "(__ghoti_print_interfaces)" -d "Query whether interface is bound to zone"
complete -c firewall-cmd -l remove-interface -xa "(__ghoti_print_interfaces)" -d "Remove binding of interface from zone"
...
# Service Options
complete -c firewall-cmd -l info-service -xa "(__ghoti_print_firewalld_services)" -d "Print information about the service"
...
complete -c firewall-cmd -l delete-service -xa "(__ghoti_print_firewalld_services)" -d "Delete an existing permanent service"
complete -c firewall-cmd -l load-service-defaults -xa "(__ghoti_print_firewalld_services)" -d "Load service default settings"
complete -c firewall-cmd -l path-service -xa "(__ghoti_print_firewalld_services)" -d "Print path of the service configuration file"
complete -c firewall-cmd -l service -xa "(__ghoti_print_firewalld_services)" -d "Apply settings to this service"
...
complete -c firewall-cmd -l add-helper -xa "(__ghoti_print_firewalld_helpers)" -d "Add a new helper to the permanent service"
complete -c firewall-cmd -l remove-helper -xa "(__ghoti_print_firewalld_helpers)" -d "Remove a helper from the permanent service"
complete -c firewall-cmd -l query-helper -xa "(__ghoti_print_firewalld_helpers)" -d "Return wether the helper has been added to the permanent service"
...
complete -c firewall-cmd -l add-include -xa "(__ghoti_print_firewalld_services)" -d "Add a new include to the permanent service"
complete -c firewall-cmd -l remove-include -xa "(__ghoti_print_firewalld_services)" -d "Remove a include from the permanent service"
complete -c firewall-cmd -l query-include -xa "(__ghoti_print_firewalld_services)" -d "Return wether the include has been added to the permanent service"
complete -c firewall-cmd -l get-includes -d "List includes added to the permanent service"

# Helper Options
complete -c firewall-cmd -l info-helper -xa "(__ghoti_print_firewalld_helpers)" -d "Print information about the helper"
...
complete -c firewall-cmd -l delete-helper -xa "(__ghoti_print_firewalld_helpers)" -d "Delete an existing permanent helper"
complete -c firewall-cmd -l load-helper-defaults -xa "(__ghoti_print_firewalld_helpers)" -d "Load helper default settings"
complete -c firewall-cmd -l path-helper -xa "(__ghoti_print_firewalld_helpers)" -d "Print path of the helper configuration file"
complete -c firewall-cmd -l get-helpers -d "Print predefined helpers as a space separated list"
complete -c firewall-cmd -l helper -xa "(__ghoti_print_firewalld_helpers)" -d "Apply settings to this helper"
...
complete -c firewall-cmd -l info-icmptype -xa "(__ghoti_print_firewalld_icmptypes)" -d "Print information about the icmptype"
...
complete -c firewall-cmd -l delete-icmptype -xa "(__ghoti_print_firewalld_icmptypes)" -d "Delete an existing permanent icmptype"
complete -c firewall-cmd -l load-icmptype-defaults -xa "(__ghoti_print_firewalld_icmptypes)" -d "Load icmptype default settings"
complete -c firewall-cmd -l icmptype -xa "(__ghoti_print_firewalld_icmptypes)" -d "Apply settings to this icmptype"
complete -c firewall-cmd -l add-destination -xa "ipv4 ipv6" -d "Enable destination for ipv in permanent icmptype"
complete -c firewall-cmd -l path-icmptype -xa "(__ghoti_print_firewalld_icmptypes)" -d "Print path of the icmptype configuration file"
...
complete -c firewall-cmd -l add-lockdown-whitelist-user -xa "(__ghoti_complete_users)" -d "Add the user to the whitelist"
complete -c firewall-cmd -l remove-lockdown-whitelist-user -xa "(__ghoti_complete_users)" -d "Remove the user from the whitelist"
complete -c firewall-cmd -l query-lockdown-whitelist-user -xa "(__ghoti_complete_users)" -d "Query whether the user is on the whitelist"
...
complete -c firewall-cmd -l add-protocol -xa "(__ghoti_print_firewalld_protocols)" -d "Add the protocol to zone|policy|service"
complete -c firewall-cmd -l remove-protocol -xa "(__ghoti_print_firewalld_protocols)" -d "Remove the protocol from zone|policy|service"
complete -c firewall-cmd -l query-protocol -xa "(__ghoti_print_firewalld_protocols)" -d "Return whether the protocol has been added to zone|policy|service"
