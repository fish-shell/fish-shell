...
static constexpr builtin_data_t builtin_datas[] = {
    ...
    {L"do", &builtin_generic,
     N_(L"Optional after a loop header (included for compatibility with POSIX)")},
    {L"done", &builtin_generic,
    ...
    {L"fi", &builtin_generic,
     N_(L"Alterntative to \"end\" to end an if statemnt (included for compatibility with POSIX)")},
    ...
    {L"then", &builtin_generic,
     N_(L"Optional header of an if-statement (included for compatibility with POSIX)")},
