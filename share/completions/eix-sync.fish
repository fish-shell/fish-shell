...
complete -c eix-sync -s s -xa '(__ghoti_print_users)@(__ghoti_print_hostnames):' -d "Sync via rsync from the given SERVER"
complete -c eix-sync -s c -xa '(__ghoti_print_users)@(__ghoti_print_hostnames):' -d "Sync via rsync *to* the given CLIENT"
