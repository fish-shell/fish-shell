...
complete -c setxkbmap -o compat    -d 'Specifies compatibility map component name' -xa "(cat /usr/share/X11/xkb/compat.dir | sed -re $filter)"
...
complete -c setxkbmap -o geometry  -d 'Specifies geometry component name' -xa "(cat /usr/share/X11/xkb/geometry.dir | sed -re $filter)"
complete -c setxkbmap -o I         -d 'Add <dir> to list of directories to be used' -xa '(__fish_complete_directories)'
complete -c setxkbmap -o keycodes  -d 'Specifies keycodes component name' -xa "(cat /usr/share/X11/xkb/keycodes.dir | sed -re $filter)"
complete -c setxkbmap -o keymap    -d 'Specifies name of keymap to load' -xa "(cat /usr/share/X11/xkb/keymap.dir | sed -re $filter)"
...
complete -c setxkbmap -o symbols   -d 'Specifies symbols component name' -xa "(cat /usr/share/X11/xkb/symbols.dir | sed -re $filter)"
complete -c setxkbmap -o synch     -d 'Synchronize request w/X server'
complete -c setxkbmap -o types     -d 'Specifies types component name' -xa "(cat /usr/share/X11/xkb/types.dir | sed -re $filter)"
