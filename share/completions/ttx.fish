...
complete -f -c ttx -k -a '(__ghoti_complete_suffix .otf .ttf .ttx .ttc)'
complete -c ttx -f -n "__ghoti_is_nth_token 1" -k -a '(__ghoti_complete_suffix .otf .ttf .ttx)'

# General options
complete -c ttx -f -s h -d'Show help message'
complete -c ttx -f -l version -d'Show version info'
complete -c ttx -x -s d -d'Set output folder' -a '(__ghoti_complete_directories)'
complete -c ttx -r -s o -d'Set output filename' -k -a '(__ghoti_complete_suffix .otf .ttf .ttx)'
...
complete -c ttx -x -l unicodedata -d'Custom database for character names [UnicodeData.txt]' -k -a '(__ghoti_complete_suffix .txt)'
complete -c ttx -x -l newline -d'Set EOL format' -a "$line_endings"

# Compile options
complete -c ttx -x -s m -d'Merge named TTF/OTF with SINGLE .ttx input' -k -a '(__ghoti_complete_suffix .otf .ttf)'
