...
complete -c compare -o highlight-color -d 'Emphasize pixel differences with this color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c compare -o lowlight-color -d 'De-emphasize pixel differences with this color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c compare -o transparent-color -d 'Transparent color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c compare -o log -d 'Format of debugging information [format]' -xa '(__ghoti_complete_convert_options format)'
