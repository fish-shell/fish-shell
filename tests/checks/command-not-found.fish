...
#CHECKERR: fish: Unknown command. A component of './file_8de9325e/bar' is not a directory.
...
#CHECKERR: fish: Unknown command. './{{(?:A{300})}}': File name too long.
...
#CHECKERR: fish: Unknown command. './dir_8de9325e' exists, but files of this type cannot be executed.
...
foobar --banana
echo $status
# CHECKERR: {{.*}}checks/command-not-found.fish (line {{\d+}}): Unknown command. Missing execute permissions for './foobar' or one of its parent directories.
