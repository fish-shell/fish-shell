...
- ``\cX``, where ``X`` is a letter of the alphabet, represents the control sequence generated by pressing the control key and the specified letter.
  For example, ``\ci`` is the tab character.
  See `C0 controls codes <https://en.wikipedia.org/wiki/C0_and_C1_control_codes#C0_controls>`__ on Wikipedia.
