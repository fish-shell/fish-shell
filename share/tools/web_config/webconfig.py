...
def parse_color(color_str):
    ...
    for comp in comps:
        ...
        if comp == "--bold" or comp == "-o":
            ...
            def parse_opt(current_best: str, long_opt: str, short_opt: str | None) -> str:
                if comp.startswith(long_opt):
                    ...
                    if better_color(current_best, parsed_c) == parsed_c:
                        return c
                return current_best
            background_color, is_bg = parse_opt(background_color, "--background", "-b")
            underline_color, is_ul = parse_opt(underline_color, "--underline-color", None)
