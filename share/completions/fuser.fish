if __fish_supports_version fuser
    ...
    complete -c fuser -s c -d 'Treat file as a mount point'
    complete -c fuser -s f -d 'Report only for the named files'
    complete -c fuser -s u -d 'Print the user name associated with each process'
end
