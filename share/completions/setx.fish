...
complete -c setx -f -n '__ghoti_seen_argument -w s' -a /u \
    -d 'Run the script with the credentials of the specified user account'
complete -c setx -f -n '__ghoti_seen_argument -w u' -a /p \
    -d 'Specify the password of the user account that is specified in the /u parameter'

complete -c setx -f -n 'not __ghoti_seen_argument -w a -w r -w x' -a /a \
    -d 'Specify absolute coordinates and offset as search parameters'
complete -c setx -f -n 'not __ghoti_seen_argument -w a -w r -w x' -a /r \
    -d 'Specify relative coordinates and offset'
complete -c setx -f -n 'not __ghoti_seen_argument -w a -w r -w x' -a /x \
    -d 'Display file coordinates, ignoring the /a, /r, and /d command-line options'

complete -c setx -f -n '__ghoti_seen_argument -w a -w r' -a /m \
