...
complete -c lpadmin -s R -d 'Deletes the named option from printer' -xa '(__ghoti_print_lpr_options)'
...
complete -c lpadmin -s P -d 'Specify a PDD file to use with the printer' -k -xa "(__ghoti_complete_suffix .ppd .ppd.gz)"
...
complete -c lpadmin -s o -d 'Sets a  PPD option for the printer' -xa '(__ghoti_complete_lpr_option)'
#complete -c lpadmin -s o -d 'Sets a default server-side option for the destination' -xa '(__ghoti_complete_lpr_option | sed "s/=/-default=/")'
...
complete -c lpadmin -s u -xa 'allow:all allow:none (__ghoti_complete_list , __ghoti_complete_users allow:)' -d 'Sets user-level access control on a destination'
complete -c lpadmin -s u -xa '(__ghoti_complete_list , __ghoti_complete_groups allow: @)' -d 'Sets user-level access control on a destination'
complete -c lpadmin -s u -xa 'deny:all deny:none (__ghoti_complete_list , __ghoti_complete_users deny:)' -d 'Sets user-level access control on a destination'
complete -c lpadmin -s u -xa '(__ghoti_complete_list , __ghoti_complete_groups deny: @)' -d 'Sets user-level access control on a destination'
