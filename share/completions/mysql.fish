...
complete -c mysql -l character-sets-dir -x -a "(__ghoti_complete_directories)" -d 'Set directory where character sets are installed'
...
complete -c mysql -s h -l host -x -a "(__ghoti_print_hostnames)" -d 'Connect to the server on the given host'
...
complete -c mysql -l plugin-dir -x -a "(__ghoti_complete_directories)" -d 'Directory for client-side plugins'
...
complete -c mysql -l ssl-capath -x -a "(__ghoti_complete_directories)" -d 'CA directory'
...
complete -c mysql -l ssl-crlpath -x -a "(__ghoti_complete_directories)" -d 'Certificate revocation list path'
