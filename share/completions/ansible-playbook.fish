...
complete -c ansible-playbook -s u -l user -f -a "(__ghoti_complete_users)" -d "Connect as this user (default=None)"
...
complete -c ansible-playbook -l become-user -r -f -a "(__ghoti_complete_users)" -d "Run operations as this user (default=root)"
