...
if __fish_supports_version umount
    ...
    complete -c umount -s f -d "Force unmount"
    complete -c umount -s v -d "Verbose mode"
    complete -c umount -s a -d "Unmount all mounted file systems"
    complete -c umount -s A -d "Unmount all mounted file systems"
    complete -c umount -s h -x -d "Limit -a to the given host"
    complete -c umount -s t -x -a "(__fish_print_filesystems)" -d "Limit to the given file system type"
end
