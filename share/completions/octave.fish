...
complete -c octave -x -a '(__ghoti_complete_suffix .m)'
...
complete -c octave -l gui -n 'not __ghoti_seen_argument --long gui --long no-gui --long no-line-editing' -d 'Start the graphical user interface'
...
complete -c octave -l line-editing -n 'not __ghoti_seen_argument --long line-editing --long no-line-editing' -d 'Force readline use for command-line editing'
complete -c octave -l no-gui -n 'not __ghoti_seen_argument --long gui --long no-gui' -d 'Disable the graphical user interface'
...
complete -c octave -l no-line-editing -n 'not __ghoti_seen_argument --long line-editing --long no-line-editing --long gui' -d 'Don\'t use readline for command-line editing'
