...
complete -c top -s u -d "Monitor effective UID" -x -a "(__ghoti_complete_users)"
complete -c top -s U -d "Monitor user" -x -a "(__ghoti_complete_users)"
complete -c top -s p -d "Monitor PID" -x -a "(__ghoti_complete_pids)"
