function __ghoti_mkpasswd_methods --description "Complete hashing methods for mkpasswd"
...
complete -c mkpasswd -s m -l method -xa "(__ghoti_mkpasswd_methods)" -d 'Compute the password using the given method'
