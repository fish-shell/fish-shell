...
function __fish_pmset_no_verb
    ...
    for t in $toks
        ...
        if contains -- $t schedule repeat relative touch sleepnow displaysleepnow boot \
                restoredefaults resetdisplayambientparams noidle
            return 1
        end
    end
    return 0
...
complete -c pmset -n '__fish_pmset_action_is schedule; and not __fish_pmset_schedule_has_type' -f -a cancel -d 'Cancel a scheduled power event (requires type and date)'
complete -c pmset -n '__fish_pmset_action_is schedule; and not __fish_pmset_schedule_has_type' -f -a cancelall -d 'Cancel all scheduled power events'
complete -c pmset -n '__fish_pmset_action_is schedule; and not __fish_pmset_schedule_has_type' -f -a sleep -d 'Schedule a one-time sleep event'
complete -c pmset -n '__fish_pmset_action_is schedule; and not __fish_pmset_schedule_has_type' -f -a wake -d 'Schedule a one-time wake event'
complete -c pmset -n '__fish_pmset_action_is schedule; and not __fish_pmset_schedule_has_type' -f -a poweron -d 'Schedule a one-time power-on event'
complete -c pmset -n '__fish_pmset_action_is schedule; and not __fish_pmset_schedule_has_type' -f -a shutdown -d 'Schedule a one-time shutdown event'
complete -c pmset -n '__fish_pmset_action_is schedule; and not __fish_pmset_schedule_has_type' -f -a wakeorpoweron -d 'Schedule a one-time wake-or-power-on event'

complete -c pmset -n '__fish_pmset_action_is repeat; and not __fish_pmset_repeat_has_type' -f -a cancel -d 'Cancel all repeating power events'
complete -c pmset -n '__fish_pmset_action_is repeat; and not __fish_pmset_repeat_has_type' -f -a sleep -d 'Repeat: sleep on given weekdays at given time'
complete -c pmset -n '__fish_pmset_action_is repeat; and not __fish_pmset_repeat_has_type' -f -a wake -d 'Repeat: wake on given weekdays at given time'
complete -c pmset -n '__fish_pmset_action_is repeat; and not __fish_pmset_repeat_has_type' -f -a poweron -d 'Repeat: power on on given weekdays at given time'
complete -c pmset -n '__fish_pmset_action_is repeat; and not __fish_pmset_repeat_has_type' -f -a shutdown -d 'Repeat: shutdown on given weekdays at given time'
complete -c pmset -n '__fish_pmset_action_is repeat; and not __fish_pmset_repeat_has_type' -f -a wakeorpoweron -d 'Repeat: wake or power on on given weekdays at given time'
