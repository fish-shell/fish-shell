...
class editable_line_t {
   ...
   public:
    ...
    /// Modifiy the commandline by inserting a string at the cursor.
    /// This appends @str to the most recent edit, which must be an insert as well.
    void coalescing_insert(const wcstring &str);
