complete -c animate -o alpha -d 'Modify alpha channel [option]' -xa '(animate -list alpha)'
...
complete -c animate -o define -d 'Define image format options [format:option]'
...
complete -c animate -o geometry -d 'Size and location of the Image window [geometry]'
...
complete -c animate -o support -d 'Resize support [factor]'
