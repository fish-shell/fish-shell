...
complete -c tex -k -x -a "(__ghoti_complete_suffix --description='(La)TeX file' .tex)"
...
complete -c tex -o output-directory= -x -a "(__ghoti_complete_directories (commandline -ct))" -d "Output directory"
