...
complete -c equery -n '__fish_use_subcommand' -xa 'changes'     -d '"'(_ 'list changelog entries for ATOM')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'check'       -d '"'(_ 'check MD5sums and timestamps of package')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'depends'     -d '"'(_ 'list all packages depending on specified package')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'depgraph'    -d '"'(_ 'display a dependency tree for package')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'files'       -d '"'(_ 'list files owned by package')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'has'         -d '"'(_ 'list all packages for matching ENVIRONMENT data stored in /var/db/pkg')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'hasuse'      -d '"'(_ 'list all packages with specified useflag')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'keywords'    -d '"'(_ 'display keywords for specified PKG')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'list'        -d '"'(_ 'list all packages matching pattern')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'meta'        -d '"'(_ 'display metadata about PKG')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'size'        -d '"'(_ 'print size of files contained in package')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'uses'        -d '"'(_ 'display USE flags for package')'"'
complete -c equery -n '__fish_use_subcommand' -xa 'which'       -d '"'(_ 'print full path to ebuild for package')'"'
