...
function __ghoti_tshark_decode_as
...
function __ghoti_complete_wireshark
    set -l shark $argv
...
packets:\t"Switch to the next file after it contains N packets"'
    ...
    complete -c $shark -s i -ra '(__ghoti_wireshark_interface)'
    ...
    complete -c $shark -l time-stamp-type -d "Change the interface's timestamp method" -xa '(__ghoti_wireshark_choices (command tshark --list-time-stamp-types 2>/dev/null))'
    ...
    complete -c $shark -s y -l linktype -d 'Set the data link type to use while capturing packets' -xa '(__ghoti_wireshark_choices (command tshark -L 2>/dev/null))'
...
string match -r "[^/]*\\$" -- $folders)'
            complete -c $shark -s d -d 'Specify how a layer type should be dissected' -xa '(__ghoti_tshark_decode_as)'
            complete -c $shark -l enable-protocol -d 'Enable dissection of the given protocol' -xa '(__ghoti_wireshark_protocol)'
            complete -c $shark -l disable-protocol -d 'Disable dissection of the given protocol' -xa '(__ghoti_wireshark_protocol)'
            complete -c $shark -l enable-heuristic -d 'Enable dissection of heuristic protocol' -xa '(__ghoti_wireshark_heuristic)'
            complete -c $shark -l disable-heuristic -d 'Disable dissection of heuristic protocol' -xa '(__ghoti_wireshark_heuristic)'
            ...
            complete -c $shark -s N -d 'Turn on name resolution only for particular types of addresses and port numbers' -xa '( __ghoti_tshark_name_resolving_flags)'
