...
complete -c useradd -s d -l home -d 'Home directory for the new user' -x -a '(__ghoti_complete_directories)'
complete -c useradd -s G -l groups -d 'Supplementary groups' -xa '(__ghoti_append , (string split -f1 : /etc/group))'
...
complete -c useradd -s b -l base-dir -d 'The initial path prefix for a new user\'s home directory' -r -a '(__ghoti_complete_directories)'
