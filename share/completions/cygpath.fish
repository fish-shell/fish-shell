...
complete -c cygpath -s l -l long-name -d 'Print Windows long form' -n '__ghoti_seen_argument -s w -l windows; or __ghoti_seen_argument -s m -l mixed'
...
complete -c cygpath -s s -l short-name -d 'Print DOS/short form' -n '__ghoti_seen_argument -s w -l windows; or __ghoti_seen_argument -s m -l mixed'
complete -c cygpath -s C -l codepage -r -a 'ANSI OEM UTF8' -d 'Print pathname in CODEPAGE' -n '__ghoti_seen_argument -s d -l dos; or __ghoti_seen_argument -s w -l windows; or __ghoti_seen_argument -s m -l mixed'
complete -c cygpath -s A -l allusers -d 'Use "All Users" instead of current user' -n '__ghoti_seen_argument -s D -l desktop; or __ghoti_seen_argument -s O -l mydocs; or __ghoti_seen_argument -s P -l smprograms'
...
complete -c cygpath -s o -l option -d 'Read options from FILE as well' -n '__ghoti_seen_argument -s f -l file'
