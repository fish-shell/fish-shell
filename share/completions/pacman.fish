...
for condition in sync upgrade
    complete -c $progname -n "$$condition" -s w -l downloadonly -d 'Only download the target packages'
...
complete -c $progname -n "$query" -s g -l groups -d 'Display members of [all] package GROUP' -xa "$listgroups"
...
complete -c $progname -n "$query" -s l -l list -d 'List the files owned by PACKAGE' -f
...
complete -c $progname -n "$quiet" -s q -l quiet -d 'Show less information' -f
...
complete -c $progname -n "$sync" -s g -l groups -d 'Display members of [all] package GROUP' -xa "$listgroups"
...
complete -c $progname -n "$sync" -s q -l quiet -d 'Show less information' -f
...
complete -c $progname -n "$sync" -s y -l refresh -d 'Download fresh package databases [force]' -f
...
complete -c $progname -n "$files" -s y -l refresh -d 'Download fresh package databases [force]' -f
complete -c $progname -n "$files" -s l -l list -d 'List the files owned by PACKAGE' -f
