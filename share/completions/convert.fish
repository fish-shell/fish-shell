...
complete -c convert -o background -d 'Background color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c convert -o bordercolor -d 'Border color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c convert -o encoding -d 'Encoding type [type text]' -xa '(__ghoti_print_encodings)'
complete -c convert -o endian -d 'Endianness (MSB or LSB) of the image [type]' -xa '(convert -list endian)'
complete -c convert -o family -d 'Render text with this font family [name]' -xa '(__ghoti_complete_convert_options family)'
complete -c convert -o fill -d 'Color to use when filling a graphic primitive [color]' -xa '(__ghoti_complete_convert_options color)'
complete -c convert -o filter -d 'Use this filter when resizing an image [type]' -xa '(convert -list filter)'
complete -c convert -o font -d 'Render text with this font [name]' -xa '(__ghoti_complete_convert_options font)'
...
complete -c convert -o mattecolor -d 'Frame color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c convert -o stroke -d 'Graphic primitive stroke color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c convert -o transparent-color -d 'Transparent color [color]' -xa '(__ghoti_complete_convert_options color)'
complete -c convert -o undercolor -d 'Annotation bounding box color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c convert -o level-colors -d 'Level image with the given colors [color,color]' -xa '(__ghoti_complete_list , "__ghoti_complete_convert_options color")'
...
complete -c convert -o opaque -d 'Change this color to the fill color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c convert -o transparent -d 'Make this color transparent within the image [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c convert -o log -d 'Format of debugging information [format]' -xa '(__ghoti_complete_convert_options format)'
