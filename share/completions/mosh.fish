...
complete -x -c mosh -d Hostname -a "(__ghoti_complete_user_at_hosts)"

complete -x -c mosh -d User -a "
(__ghoti_print_users)@
"
complete -c mosh -n 'test (__ghoti_number_of_cmd_args_wo_opts) -ge 2' -d "Command to run" -x -a '(__ghoti_complete_subcommand --fcs-skip=2)'
