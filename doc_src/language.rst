...
.. envvar:: fish_typo_completion_distance

   controls the distance of autocorrection of typos. Set it to 0 to disable, higher values mean less accurate corrections.
