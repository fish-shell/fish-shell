...
complete -c caffeinate -s w -x -a '(__ghoti_complete_pids)' -d 'Waits for the process with the specified PID to exit'

complete -c caffeinate -x -a '(__ghoti_complete_subcommand)'
