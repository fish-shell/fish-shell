...
complete -c amixer -xa "$cmds" -n "not __ghoti_seen_subcommand_from $cmds"
complete -c amixer -n '__ghoti_seen_subcommand_from sset sget get set' -xa "(amixer scontrols | string split -f 2 \')"
