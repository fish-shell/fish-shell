...
### setup
complete -c meson -n __fish_meson_needs_command -xa setup -d 'Configure a build directory'
# All of the setup options are also exposed to the global scope
complete -c meson -n '__fish_meson_needs_command || __fish_meson_using_command setup' -xa '(__fish_complete_directories)'
...
### configure
complete -c meson -n __fish_meson_needs_command -xa configure -d 'Change project options'
...
### dist
complete -c meson -n __fish_meson_needs_command -xa dist -d 'Generate a release archive'
...
### install
complete -c meson -n __fish_meson_needs_command -xa install -d 'Install the project'
...
### introspect
complete -c meson -n __fish_meson_needs_command -xa introspect -d 'Display info about a project'
...
### init
complete -c meson -n __fish_meson_needs_command -xa init -d 'Create a project from template'
...
### test
complete -c meson -n __fish_meson_needs_command -xa test -d 'Run tests for the project'
...
complete -c meson -n __fish_meson_needs_command -xa wrap -d 'Manage WrapDB dependencies'
...
complete -c meson -n __fish_meson_needs_command -xa subprojects -d 'Manage subprojects'
...
complete -c meson -n __fish_meson_needs_command -xa rewrite -d 'Modify the project'
...
### compile
complete -c meson -n __fish_meson_needs_command -xa compile -d 'Build the configured project'
...
### devenv
complete -c meson -n __fish_meson_needs_command -xa devenv -d 'Run a command from the build directory'
...
### help
complete -c meson -n __fish_meson_needs_command -xa help -d 'Show help for a command'
