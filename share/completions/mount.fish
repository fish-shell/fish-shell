...
complete -c mount -a '(__ghoti_complete_blockdevice)'
...
complete -c mount -x -s t -d 'File system' -a "(__ghoti_print_filesystems)"
complete -c mount -x -s o -d 'Mount option' -a '(__ghoti_complete_mount_opts)'
