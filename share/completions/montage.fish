...
complete -c montage -o bordercolor -d 'Border color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c montage -o encoding -d 'Encoding type [type text]' -xa '(__ghoti_print_encodings)'
...
complete -c montage -o fill -d 'Color to use when filling a graphic primitive [color]' -xa '(__ghoti_complete_convert_options color)'
complete -c montage -o filter -d 'Use this filter when resizing an image [type]' -xa '(montage -list filter)'
complete -c montage -o font -d 'Render text with this font [name]' -xa '(__ghoti_complete_convert_options font)'
...
complete -c montage -o mattecolor -d 'Frame color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c montage -o stroke -d 'Color to use when stroking a graphic primitive [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c montage -o transparent-color -d 'Transparent color [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c montage -o transparent -d 'Make this color transparent within the image [color]' -xa '(__ghoti_complete_convert_options color)'
...
complete -c montage -o log -d 'Format of debugging information [format]' -xa '(__ghoti_complete_convert_options format)'
