...
- The CMake option ``WITH_GETTEXT`` has been renamed to ``LOCALIZE_MESSAGES``, to reflect that it toggles localization independently of the backend used in the implementation.
