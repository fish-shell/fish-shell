...
__ghoti_gnu_complete -c sed -s n -l quiet -d "Silent mode" $is_gnu
__ghoti_gnu_complete -c sed -s e -l expression -x -d "Evaluate expression" $is_gnu
__ghoti_gnu_complete -c sed -s f -l file -r -d "Evalute file" $is_gnu
__ghoti_gnu_complete -c sed -s i -l in-place -d "Edit files in place" $is_gnu
