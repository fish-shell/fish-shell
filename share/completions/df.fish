...
__ghoti_gnu_complete -c df -s h -l human-readable -d "Human readable sizes" $is_gnu
__ghoti_gnu_complete -c df -s i -l inodes -d "List inode information" $is_gnu
__ghoti_gnu_complete -c df -s k -d "Use 1kB block size" $is_gnu
__ghoti_gnu_complete -c df -s l -l local -d "List only local file systems" $is_gnu
__ghoti_gnu_complete -c df -s P -l portability -d "Use POSIX format" $is_gnu
__ghoti_gnu_complete -c df -s t -l type -r -d "Show file systems of specified type" $is_gnu -x -a "(__ghoti_print_filesystems)"
...
if test -n "$is_gnu"
    ...
    complete -c df -s x -l exclude-type -d "Excluded file system type" -r -x -a "(__ghoti_print_filesystems)"
