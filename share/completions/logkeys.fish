...
complete -c logkeys -s m -l keymap -n '__ghoti_not_contain_opt -s u' -d 'Use file as input KEYMAP'
complete -c logkeys -s d -l device -d 'Use DEVICE as keyboard input'
complete -c logkeys -s u -l us-keymap -n '__ghoti_not_contain_opt -s m' -d 'Treat keyboard as standard US keyboard'
