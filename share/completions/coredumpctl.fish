...
complete -c coredumpctl -n "not __ghoti_seen_subcommand_from $commands" -a list -d 'List available coredumps'
complete -c coredumpctl -n "not __ghoti_seen_subcommand_from $commands" -a info -d 'Show detailed information about coredump(s)'
complete -c coredumpctl -n "not __ghoti_seen_subcommand_from $commands" -a dump -d 'Print first matching coredump to stdout'
complete -c coredumpctl -n "not __ghoti_seen_subcommand_from $commands" -a debug -d 'Start a debugger for the first matching coredump'
