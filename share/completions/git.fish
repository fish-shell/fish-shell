...
complete -f -c git -n '__fish_git_using_command commit' -l author -d 'Override the commit author'
complete -f -c git -n '__fish_git_using_command commit' -l date -d 'Override the author date'
complete -f -c git -n '__fish_git_using_command commit' -s m -l message -d 'Use the given message as the commit message'
