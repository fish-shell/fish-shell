...
if string match -q 'gpg (GnuPG) 1.*' (gpg --version)
    ...
    complete -c gpg -l pgp2 -d "Set up all options to be as PGP 2.x compliant as possible"
    complete -c gpg -l rfc1991 "Try to be more RFC-1991 compliant"
else
    __fish_complete_gpg2 gpg
end
