...
function __fish_complete_magick
    ...
    complete -c $argv -o background -d 'Background color [color]' -xa '(__fish_complete_magick_options color)'
    ...
    complete -c $argv -o bordercolor -d 'Border color [color]' -xa '(__fish_complete_magick_options color)'
    ...
    complete -c $argv -o colorspace -d 'Alternate image colorspace [type]' -xa '(magick -list colorspace)'
    ...
    complete -c $argv -o compress -d 'Type of pixel compression when writing the image [type]' -xa '(magick -list compress)'
    ...
    complete -c $argv -o direction -d 'Render text right-to-left or left-to-right [type]' -xa '(magick -list direction)'
    complete -c $argv -o display -d 'Get image or font from this X server [server]'
    complete -c $argv -o dispose -d 'Layer disposal method [method]' -xa '(magick -list dispose)'
    complete -c $argv -o dither -d 'Apply error diffusion to image [method]' -xa '(magick -list dither)'
    ...
    complete -c $argv -o endian -d 'Endianness (MSB or LSB) of the image [type]' -xa '(magick -list endian)'
    complete -c $argv -o family -d 'Render text with this font family [name]' -xa '(__fish_complete_magick_options family)'
    complete -c $argv -o fill -d 'Color to use when filling a graphic primitive [color]' -xa '(__fish_complete_magick_options color)'
    complete -c $argv -o filter -d 'Use this filter when resizing an image [type]' -xa '(magick -list filter)'
    complete -c $argv -o flatten -d 'flatten a sequence of images'
    complete -c $argv -o font -d 'Render text with this font [name]' -xa '(__fish_complete_magick_options font)'
    ...
    complete -c $argv -o gravity -d 'Horizontal and vertical text placement [type]' -xa '(magick -list gravity)'
    complete -c $argv -o green-primary -d 'Chromaticity green primary point [point]'
    complete -c $argv -o intent -d 'Type of rendering intent when managing the image color [type]' -xa '(magick -list intent)'
    complete -c $argv -o interlace -d 'Type of image interlacing scheme [type]' -xa '(magick -list interlace)'
    complete -c $argv -o interpolate -d 'Pixel color interpolation method [method]' -xa '(magick -list interpolate)'
    ...
    complete -c $argv -o mattecolor -d 'Frame color [color]' -xa '(__fish_complete_magick_options color)'
    complete -c $argv -o monitor -d 'Monitor progress'
    complete -c $argv -o orient -d 'Image orientation [type]' -xa '(magick -list orientation)'
    ...
    complete -c $argv -o preview -d 'Image preview type [type]' -xa '(magick -list preview)'
    ...
    complete -c $argv -o stretch -d 'Render text with this font stretch [type]' -xa '(magick -list stretch)'
    complete -c $argv -o stroke -d 'Graphic primitive stroke color [color]' -xa '(__fish_complete_magick_options color)'
    complete -c $argv -o strokewidth -d 'Graphic primitive stroke width [value]'
    complete -c $argv -o style -d 'Render text with this font style [type]' -xa '(magick -list style)'
    ...
    complete -c $argv -o transparent-color -d 'Transparent color [color]' -xa '(__fish_complete_magick_options color)'
    complete -c $argv -o undercolor -d 'Annotation bounding box color [color]' -xa '(__fish_complete_magick_options color)'
    complete -c $argv -o units -d 'The units of image resolution [type]' -xa '(magick -list units)'
    ...
    complete -c $argv -o virtual-pixel -d 'Virtual pixel access method [method]' -xa '(magick -list virtual-pixel)'
    ...
    complete -c $argv -o function -d 'Apply function over image values [name parameters]' -xa '(magick -list function)'
    ...
    complete -c $argv -o layers -d 'Optimize, merge,  or compare image layers [method]' -xa '(magick -list layers)'
    ...
    complete -c $argv -o morphology -d 'Apply a morphology method to the image [method kernel]' -xa '(magick -list morphology)'
    ...
    complete -c $argv -o opaque -d 'Change this color to the fill color [color]' -xa '(__fish_complete_magick_options color)'
    ...
    complete -c $argv -o quantize -d 'Reduce colors in this colorspace [colorspace]' -xa '(magick -list colorspace)'
    ...
    complete -c $argv -o transparent -d 'Make this color transparent within the image [color]' -xa '(__fish_complete_magick_options color)'
    ...
    complete -c $argv -o type -d 'Image type [type]' -xa '(magick -list type)'
    ...
    complete -c $argv -o process -d 'Process the image with a custom image filter [arguments]' -xa '(magick -list filter)'
    ...
    complete -c $argv -o debug -d 'Display copious debugging information [events]' -xa '(magick -list debug)'
    complete -c $argv -o help -d 'Print program options'
    complete -c $argv -o log -d 'Format of debugging information [format]' -xa '(__fish_complete_magick_options format)'
    complete -c $argv -o list -d 'Print a list of supported option arguments [type]' -xa '(magick -list list)'
