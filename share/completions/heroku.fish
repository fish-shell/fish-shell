...
function __ghoti_list_available_addons
    heroku addons:list | awk -F":" '/^[a-z]/ {print $1}'
end

function __ghoti_list_installed_addons
    heroku addons | awk '{if (NR>1) print $1}'
end

function __ghoti_list_heroku_apps
    heroku apps | awk '{if (NR>1) print $1}'
end

function __ghoti_list_heroku_config_keys
    heroku config | awk -F':' '{if (NR>1) print $1}'
end

function __ghoti_list_heroku_domains
    heroku domains | awk '{if (NR>1) print $1}'
end

function __ghoti_list_heroku_dynos
    heroku ps | awk -F':' '{if (NR>1) print $1}'
end

function __ghoti_list_heroku_releases
    heroku releases | awk '{if (NR>1) print $1}'
end

function __ghoti_heroku_needs_command
...
function __ghoti_heroku_using_command
    set -l cmd (commandline -opc)
...
set -l heroku_looking -c heroku -n __ghoti_heroku_needs_command
...
complete -c heroku -n '__ghoti_heroku_using_command addons:add' -fa '(__ghoti_list_available_addons)'

complete $heroku_looking -xa addons:docs -d "open an addon's documentation in your browser"
complete -c heroku -n '__ghoti_heroku_using_command addons:docs' -fa '(__ghoti_list_installed_addons)'

complete $heroku_looking -xa addons:downgrade -d 'downgrade an existing addon'
complete -c heroku -n '__ghoti_heroku_using_command addons:downgrade' -fa '(__ghoti_list_installed_addons)'
...
complete -c heroku -n '__ghoti_heroku_using_command addons:open' -fa '(__ghoti_list_installed_addons)'

complete $heroku_looking -xa addons:remove -d 'uninstall one or more addons'
complete -c heroku -n '__ghoti_heroku_using_command addons:remove' -fa '(__ghoti_list_installed_addons)'

complete $heroku_looking -xa addons:upgrade -d 'upgrade an existing addon'
complete -c heroku -n '__ghoti_heroku_using_command addons:upgrade' -fa '(__ghoti_list_installed_addons)'

# Apps options and subcommands
complete -c heroku -n '__ghoti_heroku_using_command apps' -s o -l org -l ORG -d "the org to list the apps for"
complete -c heroku -n '__ghoti_heroku_using_command apps' -s A -l all -d "list all apps in the org. Not just joined apps"
complete -c heroku -n '__ghoti_heroku_using_command apps' -s p -l personal -d "list apps in personal account when a default org is set"
...
complete -c heroku -n '__ghoti_heroku_using_command apps:destroy' -l app -s a -xa '(__ghoti_list_heroku_apps)'
...
complete -c heroku -n '__ghoti_heroku_using_command apps:join' -l app -s a

complete $heroku_looking -xa apps:leave -d " remove yourself from an organization app (--app APP)"
complete -c heroku -n '__ghoti_heroku_using_command apps:leave' -l app -s a -xa '(__ghoti_list_heroku_apps)'

complete $heroku_looking -xa apps:lock -d " lock an organization app to restrict access"
complete -c heroku -n '__ghoti_heroku_using_command apps:lock' -l app -s a -xa '(__ghoti_list_heroku_apps)'

complete $heroku_looking -xa apps:open -d " open the app in a web browser"
complete -c heroku -n '__ghoti_heroku_using_command apps:open' -l app -s a -xa '(__ghoti_list_heroku_apps)'

complete $heroku_looking -xa apps:rename -d " rename the app (apps:rename newname --app oldname)"
complete -c heroku -n '__ghoti_heroku_using_command apps:rename' -l app -s a -xa '(__ghoti_list_heroku_apps)'

complete $heroku_looking -xa apps:unlock -d " unlock an organization app so that any org member can join it"
complete -c heroku -n '__ghoti_heroku_using_command apps:unlock' -l app -s a -xa '(__ghoti_list_heroku_apps)'
...
complete -c heroku -n '__ghoti_heroku_using_command config' -s s -l shell -d "output config vars in shell format"

complete $heroku_looking -xa config:get -d "display a config value for an app"
complete -c heroku -n '__ghoti_heroku_using_command config:get' -xa '(__ghoti_list_heroku_config_keys)' -d "display a config value for an app"

complete $heroku_looking -xa config:set -d "set one or more config vars (KEY=VALUE)"
complete -c heroku -n '__ghoti_heroku_using_command config:set' -fa '(__ghoti_list_heroku_config_keys)' -d "set one or more config vars (KEY=VALUE)"

complete $heroku_looking -xa config:unset -d "unset one or more config vars"
complete -c heroku -n '__ghoti_heroku_using_command config:unset' -fa '(__ghoti_list_heroku_config_keys)' -d "unset one or more config vars"
...
complete -c heroku -n '__ghoti_heroku_using_command domains:remove' -fa '(__ghoti_list_heroku_domains)' -d "remove a custom domain from an app"

# Logs options
complete -c heroku -n '__ghoti_heroku_using_command logs' -s n -l num -l NUM -d "the number of lines to display"
complete -c heroku -n '__ghoti_heroku_using_command logs' -s p -l ps -l PS -d "only display logs from the given process"
complete -c heroku -n '__ghoti_heroku_using_command logs' -s s -l source -l SOURCE -d "only display logs from the given source"
complete -c heroku -n '__ghoti_heroku_using_command logs' -s t -l tail -d "continually stream logs"
...
complete -c heroku -n '__ghoti_heroku_using_command ps:resize' -fa '(__ghoti_list_heroku_dynos)' -d "resize dynos to the given size (DYNO1=1X|2X|PX)"

complete $heroku_looking -xa ps:restart -d "restart an app dyno"
complete -c heroku -n '__ghoti_heroku_using_command ps:restart' -fa '(__ghoti_list_heroku_dynos)' -d "restart an app dyno"

complete $heroku_looking -xa ps:scale -d "scale dynos by the given amount (DYNO1=AMOUNT1)"
complete -c heroku -n '__ghoti_heroku_using_command ps:scale' -fa '(__ghoti_list_heroku_dynos)' -d "scale dynos by the given amount (DYNO1=AMOUNT1)"

complete $heroku_looking -xa ps:stop -d "stop an app dyno"
complete -c heroku -n '__ghoti_heroku_using_command ps:stop' -fa '(__ghoti_list_heroku_dynos)' -d "stop an app dyno"

# Releases options and subcommands
complete -c heroku -n '__ghoti_heroku_using_command releases' -s n -l num -l NUM -d "number of releases to show, maximum 50"

complete $heroku_looking -xa releases:info -d "view detailed information for a release"
complete -c heroku -n '__ghoti_heroku_using_command releases:info' -fa '(__ghoti_list_heroku_releases)' -d "view detailed information for a release"

complete $heroku_looking -xa releases:rollback -d "roll back to an older release"
complete -c heroku -n '__ghoti_heroku_using_command releases:rollback' -fa '(__ghoti_list_heroku_releases)' -d "roll back to an older release"

# Run options and subcommands
complete -c heroku -n '__ghoti_heroku_using_command run' -s s -l size -l SIZE -d "specify dyno size"
...
complete -c heroku -n '__ghoti_heroku_using_command run:detached' -s t -l tail -d "stream logs for the dyno"
