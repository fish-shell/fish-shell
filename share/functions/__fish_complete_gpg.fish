function __fish_complete_gpg -d "Internal function for gpg completion code deduplication" -a __fish_complete_gpg_command
    if string match -q 'gpg (GnuPG) 1.*' (gpg --version)
        ...
        complete -c $__fish_complete_gpg_command -l rfc1991 "Try to be more RFC-1991 compliant"
    else
        ...
        complete -c $__fish_complete_gpg_command -l passwd -xa "(__fish_complete_gpg_user_id)" -d "Change the passphrase of the secret key belonging to the given user id"
        complete -c $__fish_complete_gpg_command -l pinentry-mode -xa "default ask cancel error loopback" -d "Set the pinentry mode"
        complete -c $__fish_complete_gpg_command -l quick-add-key -xa "(__fish_complete_gpg_key_id)" -d "Directly add a subkey to a key"
        complete -c $__fish_complete_gpg_command -l quick-add-uid -xa "(__fish_complete_gpg_user_id)" -d "Adds a new user id to an existing key"
        complete -c $__fish_complete_gpg_command -l quick-gen-key -xa "(__fish_complete_gpg_user_id)" -d "Generate a standard key without needing to answer prompts"
        complete -c $__fish_complete_gpg_command -l quick-generate-key -xa "(__fish_complete_gpg_user_id)" -d "Generate a standard key without needing to answer prompts"
        complete -c $__fish_complete_gpg_command -l quick-lsign-key -xa "(__fish_complete_gpg_key_id)" -d "Directly sign a key from the passphrase; marks signatures as non-exportable"
        complete -c $__fish_complete_gpg_command -l quick-revoke-uid -xa "(__fish_complete_gpg_user_id)" -d "Revokes a user id on an existing key"
        complete -c $__fish_complete_gpg_command -l quick-revuid -xa "(__fish_complete_gpg_user_id)" -d "Revokes a user id on an existing key"
        complete -c $__fish_complete_gpg_command -l quick-set-expire -xa "(__fish_complete_gpg_key_id)" -d "Set the expiration time of the specified key"
        complete -c $__fish_complete_gpg_command -l quick-set-primary-uid -xa "(__fish_complete_gpg_user_id)" -d "Sets or updates the priary uid flag for the specified key"
        complete -c $__fish_complete_gpg_command -l quick-sign-key -xa "(__fish_complete_gpg_key_id)" -d "Directly sign a key from the passphrase"
        complete -c $__fish_complete_gpg_command -l receive-keys -xa "(__fish_complete_gpg_key_id)" -d "Import the keys with the given key IDs from a keyserver"
        ...
        complete -c $__fish_complete_gpg_command -l sender -xa "(__fish_complete_gpg_user_id)" -d "When creating a signature, tells gpg the user id of a key; when verifying, used to restrict information printed"
        ...
        complete -c $__fish_complete_gpg_command -l try-secret-key -xa "(__fish_complete_gpg_key_id)" -d "Specify keys to be used for trial decryption"
        ...
        complete -c $__fish_complete_gpg_command -l list-signatures -xa "(__fish_complete_gpg_user_id)" -d "Same as --list-keys, but the signatures are listed too"
        ...
        complete -c $__fish_complete_gpg_command -l generate-revocation -xa "(__fish_complete_gpg_user_id)" -d "Generate a revocation certificate for the complete key"
        complete -c $__fish_complete_gpg_command -l generate-key -d "Generate a new key pair"
        complete -c $__fish_complete_gpg_command -l generate-designated-revocation -xa "(__fish_complete_gpg_user_id)" -d "Generate a designated revocation certificate for a key"
        ...
        complete -c $__fish_complete_gpg_command -l change-passphrase -xa "(__fish_complete_gpg_user_id)" -d "Change the passphrase of the secret key belonging to the given user id"
