...
complete -c patch -s d -l directory -r -f -d "Change to the directory dir immediately"
...
complete -c patch -s o -l output -r -f -d "Send output to outfile instead of patching files in place"
...
complete -c patch -s r -l reject-file -r -f -d "Put rejects into rejectfile instead of the default .rej file"
