...
complete -c speedtest-cli -l csv-delimiter -a "',' ';' ' '" -d 'Single character delimiter to use in CSV output' -r
...
complete -c speedtest-cli -l server -d 'Specify a server ID to test against' -r
complete -c speedtest-cli -l exclude -d 'Exclude a server from selection' -r
complete -c speedtest-cli -l mini -d 'URL of the Speedtest Mini server' -r
complete -c speedtest-cli -l source -d 'Source IP address to bind to' -r
complete -c speedtest-cli -l timeout -d 'HTTP timeout in seconds' -r
