...
An example of using ``$argv_opts`` to forward known options to another command, whilst adding new options::
    ...
    function head
        ...
        argparse --ignore-unknown $opt_spec -- $argv
