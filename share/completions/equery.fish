...
complete -c equery -n '__fish_use_subcommand' -xa 'has'         -d "List all packages for matching ENVIRONMENT data stored in /var/db/pkg"
complete -c equery -n '__fish_use_subcommand' -xa 'hasuse'      -d "List all packages with specified useflag"
